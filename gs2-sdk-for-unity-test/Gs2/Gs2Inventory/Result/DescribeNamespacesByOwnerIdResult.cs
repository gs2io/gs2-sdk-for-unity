...
{
	[Preserve]
	public class DescribeNamespacesByOwnerIdResult
	{
        /** ネームスペースのリスト */
    	...
    	[Preserve]
        public static DescribeNamespacesByOwnerIdResult FromDict(JsonData data)
        {
            return new DescribeNamespacesByOwnerIdResult {

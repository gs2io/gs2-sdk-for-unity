...
namespace Gs2.Unity.Gs2Version.Domain.Model
{
    ...
    public partial class EzUserGameSessionDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Version.Model.EzAcceptVersion> AcceptVersionsAsync(
        )
        {
            var it = _domain.AcceptVersionsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Version.Model.EzAcceptVersion.FromModel(it.Current);
                }
            }
            finally
            {

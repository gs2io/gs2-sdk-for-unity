...
namespace Gs2.Unity.Gs2Version.Domain.Model
{
    ...
    public partial class EzAcceptVersionGameSessionDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2Version.Domain.Model.EzAcceptVersionGameSessionDomain> AcceptAsync(
            #else
        public async Task<Gs2.Unity.Gs2Version.Domain.Model.EzAcceptVersionGameSessionDomain> AcceptAsync(
            #endif
            Gs2.Unity.Gs2Version.Model.EzVersion version = null
        ) {
        ...
        public async UniTask<Gs2.Unity.Gs2Version.Domain.Model.EzAcceptVersionGameSessionDomain> RejectAsync(
            #else
        public async Task<Gs2.Unity.Gs2Version.Domain.Model.EzAcceptVersionGameSessionDomain> RejectAsync(
            #endif
            Gs2.Unity.Gs2Version.Model.EzVersion version = null
        ) {
            var result = await this._connection.RunAsync(
        ...
        public async UniTask<Gs2.Unity.Gs2Version.Domain.Model.EzAcceptVersionGameSessionDomain> DeleteAsync(
            #else
        public async Task<Gs2.Unity.Gs2Version.Domain.Model.EzAcceptVersionGameSessionDomain> DeleteAsync(
            #endif
        ) {
            var result = await this._connection.RunAsync(
                this._gameSession,
        ...
        public async UniTask<Gs2.Unity.Gs2Version.Model.EzAcceptVersion> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Version.Model.EzAcceptVersion> ModelAsync()
            #endif
        {

...
namespace Gs2.Unity.Gs2Version.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        ...
        {
            return new Gs2.Unity.Gs2Version.Domain.Iterator.EzListVersionModelsIterator(
                this._domain,
                this._connection
            );
        }
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Version.Model.EzVersionModel> VersionModelsAsync(
        )
        {
            var it = _domain.VersionModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Version.Model.EzVersionModel.FromModel(it.Current);
                }
            }
            finally
            {

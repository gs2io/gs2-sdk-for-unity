...
namespace Gs2.Unity.Gs2AdReward.Domain
{
    ...
    public class Gs2AdReward {
        ...
        public Gs2.Unity.Gs2AdReward.Domain.Model.EzNamespaceDomain Namespace(
            ...
            return new Gs2.Unity.Gs2AdReward.Domain.Model.EzNamespaceDomain(
                _domain.Namespace(
                    namespaceName
                ),
                _profile
        ...
        {
            add => _domain.OnChangePointNotification += value;
            remove => _domain.OnChangePointNotification -= value;
        }
    }
}

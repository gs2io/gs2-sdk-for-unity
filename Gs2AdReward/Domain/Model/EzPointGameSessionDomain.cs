...
namespace Gs2.Unity.Gs2AdReward.Domain.Model
{
    ...
    public partial class EzPointGameSessionDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2AdReward.Model.EzPoint> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2AdReward.Model.EzPoint> ModelAsync()
            #endif
        {
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2AdReward.Model.EzPoint> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2AdReward.Model.EzPoint.FromModel(
                    item
                ));
            });
        }
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2AdReward.Model.EzPoint> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2AdReward.Model.EzPoint> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2AdReward.Model.EzPoint> callback)
            #endif
        {

...
using Gs2.Gs2MegaField.Domain.Model;
...
namespace Gs2.Unity.Gs2MegaField.Domain
{
    ...
    public class Gs2MegaField {
        ...
        public Gs2MegaField(
            Gs2.Gs2MegaField.Domain.Gs2MegaField domain,
        ...
        public Gs2.Unity.Gs2MegaField.Domain.Model.EzNamespaceDomain Namespace(
            string namespaceName
        ) {
            return new Gs2.Unity.Gs2MegaField.Domain.Model.EzNamespaceDomain(
                _domain.Namespace(
                    namespaceName
                ),
                _profile

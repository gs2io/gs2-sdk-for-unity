...
namespace Gs2.Unity.Gs2MegaField.Domain.Model
{
    ...
    public partial class EzAreaModelDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2MegaField.Model.EzLayerModel> LayerModelsAsync(
        )
        {
            var it = _domain.LayerModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2MegaField.Model.EzLayerModel.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        public async UniTask<Gs2.Unity.Gs2MegaField.Model.EzAreaModel> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2MegaField.Model.EzAreaModel> ModelAsync()
            #endif
        {

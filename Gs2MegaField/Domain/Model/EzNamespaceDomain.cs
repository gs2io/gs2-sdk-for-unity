...
namespace Gs2.Unity.Gs2MegaField.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2MegaField.Model.EzAreaModel> AreaModelsAsync(
        )
        {
            var it = _domain.AreaModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2MegaField.Model.EzAreaModel.FromModel(it.Current);
                }
            }
            finally
            {

...
namespace Gs2.Unity.Gs2MegaField.Model
{
	...
	public class EzMyPosition
	{
        ...
        public Gs2.Gs2MegaField.Model.MyPosition ToModel()
        {
            return new Gs2.Gs2MegaField.Model.MyPosition {
        ...
        public static EzMyPosition FromModel(Gs2.Gs2MegaField.Model.MyPosition model)
        {
            return new EzMyPosition {

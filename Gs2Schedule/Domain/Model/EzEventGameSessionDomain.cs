...
namespace Gs2.Unity.Gs2Schedule.Domain.Model
{
    ...
    public partial class EzEventGameSessionDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2Schedule.Model.EzEvent> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Schedule.Model.EzEvent> ModelAsync()
            #endif
        {
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Schedule.Model.EzEvent> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2Schedule.Model.EzEvent.FromModel(
                    item
                ));
            });
        }
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Schedule.Model.EzEvent> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Schedule.Model.EzEvent> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Schedule.Model.EzEvent> callback)
            #endif
        {

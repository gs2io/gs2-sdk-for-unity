...
namespace Gs2.Unity.Gs2Schedule.Domain.Model
{
    ...
    public partial class EzTriggerGameSessionDomain {
        ...
        public IFuture<Gs2.Unity.Gs2Schedule.Model.EzTrigger> Model()
        {
            ...
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<Gs2.Unity.Gs2Schedule.Model.EzTrigger> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Schedule.Model.EzTrigger> ModelAsync()
            #endif
        {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Unity.Gs2Schedule.Model.EzTrigger> ModelFuture()
        {
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Schedule.Model.EzTrigger> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2Schedule.Model.EzTrigger.FromModel(
                    item
                ));
            });
        }
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Schedule.Model.EzTrigger> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Schedule.Model.EzTrigger> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Schedule.Model.EzTrigger> callback)
            #endif
        {

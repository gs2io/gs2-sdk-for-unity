...
namespace Gs2.Unity.Gs2Schedule.Domain.Iterator
{
    ...
    public class EzDescribeEventsIterator : Gs2Iterator<Gs2.Unity.Gs2Schedule.Model.EzEvent> {
        ...
        public EzDescribeEventsIterator(
            Gs2.Gs2Schedule.Domain.Iterator.DescribeEventsIterator iterator
        ) {
        ...
        protected override IEnumerator Next(
            Action<AsyncResult<Gs2.Unity.Gs2Schedule.Model.EzEvent>> callback
        )
        {
            yield return _iterator;
            callback.Invoke(new AsyncResult<Gs2.Unity.Gs2Schedule.Model.EzEvent>(
                _iterator.Current == null ? null : Gs2.Unity.Gs2Schedule.Model.EzEvent.FromModel(_iterator.Current),
                _iterator.Error
            ));
        }

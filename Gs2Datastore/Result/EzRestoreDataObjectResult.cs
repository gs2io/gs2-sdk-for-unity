...
namespace Gs2.Unity.Gs2Datastore.Result
{
	...
	public class EzRestoreDataObjectResult
	{
		[SerializeField]
		public Gs2.Unity.Gs2Datastore.Model.EzDataObject Item;

        public static EzRestoreDataObjectResult FromModel(Gs2.Gs2Datastore.Result.RestoreDataObjectResult model)
        {
            return new EzRestoreDataObjectResult {

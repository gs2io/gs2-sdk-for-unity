...
namespace Gs2.Unity.Gs2Datastore.Result
{
	...
	public class EzPrepareDownloadOwnDataResult
	{
		[SerializeField]
        ...
        public static EzPrepareDownloadOwnDataResult FromModel(Gs2.Gs2Datastore.Result.PrepareDownloadOwnDataResult model)
        {
            return new EzPrepareDownloadOwnDataResult {

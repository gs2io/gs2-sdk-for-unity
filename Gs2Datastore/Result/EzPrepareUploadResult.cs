...
namespace Gs2.Unity.Gs2Datastore.Result
{
	...
	public class EzPrepareUploadResult
	{
		[SerializeField]
        ...
        public static EzPrepareUploadResult FromModel(Gs2.Gs2Datastore.Result.PrepareUploadResult model)
        {
            return new EzPrepareUploadResult {

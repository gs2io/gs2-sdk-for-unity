...
namespace Gs2.Unity.Gs2Datastore.Result
{
	...
	public class EzUpdateDataObjectResult
	{
		[SerializeField]
		public Gs2.Unity.Gs2Datastore.Model.EzDataObject Item;

        public static EzUpdateDataObjectResult FromModel(Gs2.Gs2Datastore.Result.UpdateDataObjectResult model)
        {
            return new EzUpdateDataObjectResult {

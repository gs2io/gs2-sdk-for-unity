...
namespace Gs2.Unity.Gs2Datastore.Domain.Model
{
    ...
    public partial class EzUserGameSessionDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2Datastore.Domain.Model.EzDataObjectGameSessionDomain> PrepareUploadAsync(
            #else
        public async Task<Gs2.Unity.Gs2Datastore.Domain.Model.EzDataObjectGameSessionDomain> PrepareUploadAsync(
            #endif
            string? name = null,
            string? scope = null,
            string? contentType = null,
        ...
        public async UniTask<Gs2.Unity.Gs2Datastore.Domain.Model.EzDataObjectGameSessionDomain> PrepareDownloadAsync(
            #else
        public async Task<Gs2.Unity.Gs2Datastore.Domain.Model.EzDataObjectGameSessionDomain> PrepareDownloadAsync(
            #endif
            string dataObjectId
        ) {
            var result = await this._connection.RunAsync(
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Datastore.Model.EzDataObject> DataObjectsAsync(
              string? status = null
        )
        {
            var it = _domain.DataObjectsAsync(
            ...
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Datastore.Model.EzDataObject.FromModel(it.Current);
                }
            }
            finally
            {

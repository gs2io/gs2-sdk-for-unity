...
namespace Gs2.Unity.Gs2Money.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        private readonly Gs2.Gs2Money.Domain.Model.NamespaceDomain _domain;
        ...
        public EzNamespaceDomain(
            Gs2.Gs2Money.Domain.Model.NamespaceDomain domain,
        ...
        public Gs2.Unity.Gs2Money.Domain.Model.EzUserDomain User(
            string userId
        ) {
            return new Gs2.Unity.Gs2Money.Domain.Model.EzUserDomain(
                _domain.User(
                    userId
                ),
                _profile

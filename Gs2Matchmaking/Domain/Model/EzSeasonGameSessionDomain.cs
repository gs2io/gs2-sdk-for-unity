...
namespace Gs2.Unity.Gs2Matchmaking.Domain.Model
{
    ...
    public partial class EzSeasonGameSessionDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Matchmaking.Model.EzSeasonGathering> DoSeasonMatchmakingAsync(
        )
        {
            var it = _domain.DoSeasonMatchmakingAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Matchmaking.Model.EzSeasonGathering.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Matchmaking.Model.EzJoinedSeasonGathering> JoinedSeasonGatheringsAsync(
        )
        {
            var it = _domain.JoinedSeasonGatheringsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Matchmaking.Model.EzJoinedSeasonGathering.FromModel(it.Current);
                }
            }
            finally
            {

...
namespace Gs2.Unity.Gs2Matchmaking.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2Matchmaking.Domain.Model.EzBallotDomain> VoteAsync(
            #else
        public async Task<Gs2.Unity.Gs2Matchmaking.Domain.Model.EzBallotDomain> VoteAsync(
            #endif
            string ballotBody,
            string ballotSignature,
            Gs2.Unity.Gs2Matchmaking.Model.EzGameResult[] gameResults = null,
        ...
        public async UniTask<Gs2.Unity.Gs2Matchmaking.Domain.Model.EzBallotDomain> VoteMultipleAsync(
            #else
        public async Task<Gs2.Unity.Gs2Matchmaking.Domain.Model.EzBallotDomain> VoteMultipleAsync(
            #endif
            Gs2.Unity.Gs2Matchmaking.Model.EzSignedBallot[] signedBallots = null,
            Gs2.Unity.Gs2Matchmaking.Model.EzGameResult[] gameResults = null,
            string keyId = null
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Matchmaking.Model.EzRatingModel> RatingModelsAsync(
        )
        {
            var it = _domain.RatingModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Matchmaking.Model.EzRatingModel.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Matchmaking.Model.EzSeasonModel> SeasonModelsAsync(
        )
        {
            var it = _domain.SeasonModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Matchmaking.Model.EzSeasonModel.FromModel(it.Current);
                }
            }
            finally
            {

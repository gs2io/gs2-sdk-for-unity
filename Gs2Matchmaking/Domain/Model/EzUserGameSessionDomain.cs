...
namespace Gs2.Unity.Gs2Matchmaking.Domain.Model
{
    ...
    public partial class EzUserGameSessionDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2Matchmaking.Domain.Model.EzGatheringGameSessionDomain> CreateGatheringAsync(
            #else
        public async Task<Gs2.Unity.Gs2Matchmaking.Domain.Model.EzGatheringGameSessionDomain> CreateGatheringAsync(
            #endif
            Gs2.Unity.Gs2Matchmaking.Model.EzPlayer player,
            Gs2.Unity.Gs2Matchmaking.Model.EzAttributeRange[] attributeRanges = null,
            Gs2.Unity.Gs2Matchmaking.Model.EzCapacityOfRole[] capacityOfRoles = null,
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Matchmaking.Model.EzGathering> DoMatchmakingAsync(
            Gs2.Unity.Gs2Matchmaking.Model.EzPlayer player
        )
        {
            var it = _domain.DoMatchmakingAsync(
            ...
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Matchmaking.Model.EzGathering.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Matchmaking.Model.EzRating> RatingsAsync(
        )
        {
            var it = _domain.RatingsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Matchmaking.Model.EzRating.FromModel(it.Current);
                }
            }
            finally
            {

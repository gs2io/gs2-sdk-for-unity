...
namespace Gs2.Unity.Gs2Matchmaking.Result
{
	...
	public class EzCancelMatchmakingResult
	{
		[SerializeField]
		public Gs2.Unity.Gs2Matchmaking.Model.EzGathering Item;

        public static EzCancelMatchmakingResult FromModel(Gs2.Gs2Matchmaking.Result.CancelMatchmakingResult model)
        {
            return new EzCancelMatchmakingResult {

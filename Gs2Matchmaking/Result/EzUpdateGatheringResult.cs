...
namespace Gs2.Unity.Gs2Matchmaking.Result
{
	...
	public class EzUpdateGatheringResult
	{
		[SerializeField]
		public Gs2.Unity.Gs2Matchmaking.Model.EzGathering Item;

        public static EzUpdateGatheringResult FromModel(Gs2.Gs2Matchmaking.Result.UpdateGatheringResult model)
        {
            return new EzUpdateGatheringResult {

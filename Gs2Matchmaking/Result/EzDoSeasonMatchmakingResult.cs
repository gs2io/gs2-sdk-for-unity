...
namespace Gs2.Unity.Gs2Matchmaking.Result
{
	...
	public class EzDoSeasonMatchmakingResult
	{
		[SerializeField]
        ...
        public static EzDoSeasonMatchmakingResult FromModel(Gs2.Gs2Matchmaking.Result.DoSeasonMatchmakingResult model)
        {
            return new EzDoSeasonMatchmakingResult {

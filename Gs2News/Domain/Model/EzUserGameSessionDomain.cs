...
namespace Gs2.Unity.Gs2News.Domain.Model
{
    ...
    public partial class EzUserGameSessionDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2News.Model.EzNews> NewsesAsync(
        )
        {
            var it = _domain.NewsesAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2News.Model.EzNews.FromModel(it.Current);
                }
            }
            finally
            {

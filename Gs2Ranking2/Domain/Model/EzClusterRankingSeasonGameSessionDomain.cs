...
namespace Gs2.Unity.Gs2Ranking2.Domain.Model
{
    ...
    public partial class EzClusterRankingSeasonGameSessionDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2Ranking2.Domain.Model.EzClusterRankingDataGameSessionDomain> GetClusterRankingRankAsync(
            #else
        public async Task<Gs2.Unity.Gs2Ranking2.Domain.Model.EzClusterRankingDataGameSessionDomain> GetClusterRankingRankAsync(
            #endif
        ) {
        ...
        public async UniTask<Gs2.Unity.Gs2Ranking2.Domain.Model.EzClusterRankingScoreGameSessionDomain> PutClusterRankingAsync(
            #else
        public async Task<Gs2.Unity.Gs2Ranking2.Domain.Model.EzClusterRankingScoreGameSessionDomain> PutClusterRankingAsync(
            #endif
            long score,
            string? metadata = null
        ) {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Ranking2.Model.EzClusterRankingData> ClusterRankingsAsync(
        )
        {
            var it = _domain.ClusterRankingsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Ranking2.Model.EzClusterRankingData.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Ranking2.Model.EzClusterRankingReceivedReward> ClusterRankingReceivedRewardsAsync(
        )
        {
            var it = _domain.ClusterRankingReceivedRewardsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Ranking2.Model.EzClusterRankingReceivedReward.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Ranking2.Model.EzClusterRankingScore> ClusterRankingScoresAsync(
        )
        {
            var it = _domain.ClusterRankingScoresAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Ranking2.Model.EzClusterRankingScore.FromModel(it.Current);
                }
            }
            finally
            {

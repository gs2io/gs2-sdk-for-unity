...
namespace Gs2.Unity.Gs2Ranking2.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Ranking2.Model.EzGlobalRankingModel> GlobalRankingModelsAsync(
        )
        {
            var it = _domain.GlobalRankingModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Ranking2.Model.EzGlobalRankingModel.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Ranking2.Model.EzClusterRankingModel> ClusterRankingModelsAsync(
        )
        {
            var it = _domain.ClusterRankingModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Ranking2.Model.EzClusterRankingModel.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Ranking2.Model.EzSubscribeRankingModel> SubscribeRankingModelsAsync(
        )
        {
            var it = _domain.SubscribeRankingModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Ranking2.Model.EzSubscribeRankingModel.FromModel(it.Current);
                }
            }
            finally
            {

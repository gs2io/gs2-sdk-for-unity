...
namespace Gs2.Unity.Gs2Ranking2.Domain.Iterator
{
    ...
    public class EzListGlobalRankingScoresIterator : Gs2Iterator<Gs2.Unity.Gs2Ranking2.Model.EzGlobalRankingScore>
    {
        ...
        protected override IEnumerator Next(Action<AsyncResult<Gs2.Unity.Gs2Ranking2.Model.EzGlobalRankingScore>> callback)
        {
            ...
            callback.Invoke(
                new AsyncResult<Gs2.Unity.Gs2Ranking2.Model.EzGlobalRankingScore>(
                    _it.Current == null ? null : Gs2.Unity.Gs2Ranking2.Model.EzGlobalRankingScore.FromModel(_it.Current),
                    _it.Error
                )
            );
        }

...
namespace Gs2.Unity.Gs2Ranking2.Domain.Iterator
{
    ...
    public class EzListClusterRankingsIterator : Gs2Iterator<Gs2.Unity.Gs2Ranking2.Model.EzClusterRankingData>
    {
        ...
        protected override IEnumerator Next(Action<AsyncResult<Gs2.Unity.Gs2Ranking2.Model.EzClusterRankingData>> callback)
        {
            ...
            callback.Invoke(
                new AsyncResult<Gs2.Unity.Gs2Ranking2.Model.EzClusterRankingData>(
                    _it.Current == null ? null : Gs2.Unity.Gs2Ranking2.Model.EzClusterRankingData.FromModel(_it.Current),
                    _it.Error
                )
            );
        }

...
namespace Gs2.Unity.Gs2Ranking2.Domain.Iterator
{
    ...
    public class EzListClusterRankingReceivedRewardsIterator : Gs2Iterator<Gs2.Unity.Gs2Ranking2.Model.EzClusterRankingReceivedReward>
    {
        ...
        protected override IEnumerator Next(Action<AsyncResult<Gs2.Unity.Gs2Ranking2.Model.EzClusterRankingReceivedReward>> callback)
        {
            ...
            callback.Invoke(
                new AsyncResult<Gs2.Unity.Gs2Ranking2.Model.EzClusterRankingReceivedReward>(
                    _it.Current == null ? null : Gs2.Unity.Gs2Ranking2.Model.EzClusterRankingReceivedReward.FromModel(_it.Current),
                    _it.Error
                )
            );
        }

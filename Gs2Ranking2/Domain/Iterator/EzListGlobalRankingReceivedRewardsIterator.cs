...
namespace Gs2.Unity.Gs2Ranking2.Domain.Iterator
{
    ...
    public class EzListGlobalRankingReceivedRewardsIterator : Gs2Iterator<Gs2.Unity.Gs2Ranking2.Model.EzGlobalRankingReceivedReward>
    {
        ...
        protected override IEnumerator Next(Action<AsyncResult<Gs2.Unity.Gs2Ranking2.Model.EzGlobalRankingReceivedReward>> callback)
        {
            ...
            callback.Invoke(
                new AsyncResult<Gs2.Unity.Gs2Ranking2.Model.EzGlobalRankingReceivedReward>(
                    _it.Current == null ? null : Gs2.Unity.Gs2Ranking2.Model.EzGlobalRankingReceivedReward.FromModel(_it.Current),
                    _it.Error
                )
            );
        }

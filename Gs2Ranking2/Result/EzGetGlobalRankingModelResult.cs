...
namespace Gs2.Unity.Gs2Ranking2.Result
{
	...
	public class EzGetGlobalRankingModelResult
	{
		[SerializeField]
		public Gs2.Unity.Gs2Ranking2.Model.EzGlobalRankingModel Item;

        public static EzGetGlobalRankingModelResult FromModel(Gs2.Gs2Ranking2.Result.GetGlobalRankingModelResult model)
        {
            return new EzGetGlobalRankingModelResult {

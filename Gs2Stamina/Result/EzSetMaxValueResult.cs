...
namespace Gs2.Unity.Gs2Stamina.Result
{
	...
	public class EzSetMaxValueResult
	{
		[SerializeField]
        ...
        public static EzSetMaxValueResult FromModel(Gs2.Gs2Stamina.Result.SetMaxValueByStatusResult model)
        {
            return new EzSetMaxValueResult {

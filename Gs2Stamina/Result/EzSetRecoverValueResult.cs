...
namespace Gs2.Unity.Gs2Stamina.Result
{
	...
	public class EzSetRecoverValueResult
	{
		[SerializeField]
        ...
        public static EzSetRecoverValueResult FromModel(Gs2.Gs2Stamina.Result.SetRecoverValueByStatusResult model)
        {
            return new EzSetRecoverValueResult {

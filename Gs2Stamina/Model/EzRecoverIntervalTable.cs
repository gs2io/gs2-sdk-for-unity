...
namespace Gs2.Unity.Gs2Stamina.Model
{
	...
	public class EzRecoverIntervalTable
	{
        ...
        public Gs2.Gs2Stamina.Model.RecoverIntervalTable ToModel()
        {
            return new Gs2.Gs2Stamina.Model.RecoverIntervalTable {
                Name = Name,
                Metadata = Metadata,
        ...
        public static EzRecoverIntervalTable FromModel(Gs2.Gs2Stamina.Model.RecoverIntervalTable model)
        {
            return new EzRecoverIntervalTable {

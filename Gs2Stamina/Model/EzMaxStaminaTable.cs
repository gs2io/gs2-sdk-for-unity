...
namespace Gs2.Unity.Gs2Stamina.Model
{
	...
	public class EzMaxStaminaTable
	{
        ...
        public Gs2.Gs2Stamina.Model.MaxStaminaTable ToModel()
        {
            return new Gs2.Gs2Stamina.Model.MaxStaminaTable {
                Name = Name,
                Metadata = Metadata,
        ...
        public static EzMaxStaminaTable FromModel(Gs2.Gs2Stamina.Model.MaxStaminaTable model)
        {
            return new EzMaxStaminaTable {

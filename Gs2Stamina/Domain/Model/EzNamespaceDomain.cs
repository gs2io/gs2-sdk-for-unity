...
namespace Gs2.Unity.Gs2Stamina.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Stamina.Model.EzStaminaModel> StaminaModelsAsync(
        )
        {
            var it = _domain.StaminaModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Stamina.Model.EzStaminaModel.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        public ulong SubscribeStaminaModels(
            Action<Gs2.Unity.Gs2Stamina.Model.EzStaminaModel[]> callback
        ) {
            return this._domain.SubscribeStaminaModels(
                items => {
                    callback.Invoke(items.Select(Gs2.Unity.Gs2Stamina.Model.EzStaminaModel.FromModel).ToArray());
                }
            );
        }
        ...
        public void UnsubscribeStaminaModels(
            ...
            this._domain.UnsubscribeStaminaModels(
                callbackId
            );
        }
        ...
        public void InvalidateStaminaModels(
            ...
            this._domain.InvalidateStaminaModels(
            );
        }

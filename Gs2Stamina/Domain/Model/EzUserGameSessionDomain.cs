...
namespace Gs2.Unity.Gs2Stamina.Domain.Model
{
    ...
    public partial class EzUserGameSessionDomain {
        ...
        {
            return new Gs2.Unity.Gs2Stamina.Domain.Iterator.EzListStaminasIterator(
                this._domain,
                this._gameSession,
                this._connection
            );
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Stamina.Model.EzStamina> StaminasAsync(
        )
        {
            var it = _domain.StaminasAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Stamina.Model.EzStamina.FromModel(it.Current);
                }
            }
            finally
            {

...
namespace Gs2.Unity.Gs2LoginReward.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        ...
        {
            return new Gs2.Unity.Gs2LoginReward.Domain.Iterator.EzListBonusModelsIterator(
                this._domain,
                this._connection
            );
        }
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2LoginReward.Model.EzBonusModel> BonusModelsAsync(
        )
        {
            var it = _domain.BonusModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2LoginReward.Model.EzBonusModel.FromModel(it.Current);
                }
            }
            finally
            {

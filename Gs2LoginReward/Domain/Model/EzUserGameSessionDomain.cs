...
namespace Gs2.Unity.Gs2LoginReward.Domain.Model
{
    ...
    public partial class EzUserGameSessionDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2LoginReward.Model.EzReceiveStatus> ReceiveStatusesAsync(
        )
        {
            var it = _domain.ReceiveStatusesAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2LoginReward.Model.EzReceiveStatus.FromModel(it.Current);
                }
            }
            finally
            {

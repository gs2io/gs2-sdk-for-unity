...
namespace Gs2.Unity.Gs2LoginReward.Result
{
	...
	public class EzGetReceiveStatusResult
	{
		[SerializeField]
        ...
        public static EzGetReceiveStatusResult FromModel(Gs2.Gs2LoginReward.Result.GetReceiveStatusResult model)
        {
            return new EzGetReceiveStatusResult {

...
namespace Gs2.Unity.Gs2LoginReward.Model
{
	...
	public class EzConfig
	{
        ...
        public Gs2.Gs2LoginReward.Model.Config ToModel()
        {
            return new Gs2.Gs2LoginReward.Model.Config {
                Key = Key,
                Value = Value,
            };
        }

        public static EzConfig FromModel(Gs2.Gs2LoginReward.Model.Config model)
        {
            return new EzConfig {

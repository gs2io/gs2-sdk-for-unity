...
namespace Gs2.Unity.Gs2LoginReward.Model
{
	...
	public class EzReward
	{
        ...
        public Gs2.Gs2LoginReward.Model.Reward ToModel()
        {
            return new Gs2.Gs2LoginReward.Model.Reward {
        ...
        public static EzReward FromModel(Gs2.Gs2LoginReward.Model.Reward model)
        {
            return new EzReward {

...
namespace Gs2.Unity.Gs2Dictionary.Domain.Model
{
    ...
    public partial class EzLikeGameSessionDomain {
        private readonly Gs2.Gs2Dictionary.Domain.Model.LikeAccessTokenDomain _domain;
        ...
        public EzLikeGameSessionDomain(
            Gs2.Gs2Dictionary.Domain.Model.LikeAccessTokenDomain domain,
        ...
        public async UniTask<Gs2.Unity.Gs2Dictionary.Model.EzLike> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Dictionary.Model.EzLike> ModelAsync()
            #endif
        {

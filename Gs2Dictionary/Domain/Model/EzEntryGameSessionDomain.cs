...
namespace Gs2.Unity.Gs2Dictionary.Domain.Model
{
    ...
    public partial class EzEntryGameSessionDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2Dictionary.Model.EzEntry> ModelAsync()
        {
            ...
            return Gs2.Unity.Gs2Dictionary.Model.EzEntry.FromModel(
                item
            );
        }
        #endif
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Dictionary.Model.EzEntry> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(Gs2.Unity.Gs2Dictionary.Model.EzEntry.FromModel(
                    item
                ));
            });
        }
        ...
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Dictionary.Model.EzEntry> callback)
        {
            ...
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Dictionary.Model.EzEntry> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Dictionary.Model.EzEntry> callback)
            #endif
        {

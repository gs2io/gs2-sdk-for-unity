...
namespace Gs2.Unity.Gs2Dictionary.Model
{
	...
	public class EzConfig
	{
        ...
        public Gs2.Gs2Dictionary.Model.Config ToModel()
        {
            return new Gs2.Gs2Dictionary.Model.Config {
                Key = Key,
                Value = Value,
            };
        }

        public static EzConfig FromModel(Gs2.Gs2Dictionary.Model.Config model)
        {
            return new EzConfig {

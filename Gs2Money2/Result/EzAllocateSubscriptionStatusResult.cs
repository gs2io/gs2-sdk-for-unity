...
namespace Gs2.Unity.Gs2Money2.Result
{
	...
	public class EzAllocateSubscriptionStatusResult
	{
		[SerializeField]
		public Gs2.Unity.Gs2Money2.Model.EzSubscriptionStatus Item;

        public static EzAllocateSubscriptionStatusResult FromModel(Gs2.Gs2Money2.Result.AllocateSubscriptionStatusResult model)
        {
            return new EzAllocateSubscriptionStatusResult {

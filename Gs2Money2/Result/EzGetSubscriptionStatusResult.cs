...
namespace Gs2.Unity.Gs2Money2.Result
{
	...
	public class EzGetSubscriptionStatusResult
	{
		[SerializeField]
		public Gs2.Unity.Gs2Money2.Model.EzSubscriptionStatus Item;

        public static EzGetSubscriptionStatusResult FromModel(Gs2.Gs2Money2.Result.GetSubscriptionStatusResult model)
        {
            return new EzGetSubscriptionStatusResult {

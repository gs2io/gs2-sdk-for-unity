...
namespace Gs2.Unity.Gs2Money2.Domain.Model
{
    ...
    public partial class EzUserGameSessionDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2Money2.Domain.Model.EzSubscriptionStatusGameSessionDomain> AllocateSubscriptionStatusAsync(
            #else
        public async Task<Gs2.Unity.Gs2Money2.Domain.Model.EzSubscriptionStatusGameSessionDomain> AllocateSubscriptionStatusAsync(
            #endif
            string receipt
        ) {
        ...
        public async UniTask<Gs2.Unity.Gs2Money2.Domain.Model.EzSubscriptionStatusGameSessionDomain> TakeOverSubscriptionStatusAsync(
            #else
        public async Task<Gs2.Unity.Gs2Money2.Domain.Model.EzSubscriptionStatusGameSessionDomain> TakeOverSubscriptionStatusAsync(
            #endif
            string receipt
        ) {
            var result = await this._connection.RunAsync(
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Money2.Model.EzWallet> WalletsAsync(
        )
        {
            var it = _domain.WalletsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Money2.Model.EzWallet.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Money2.Model.EzSubscriptionStatus> SubscriptionStatusesAsync(
        )
        {
            var it = _domain.SubscriptionStatusesAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Money2.Model.EzSubscriptionStatus.FromModel(it.Current);
                }
            }
            finally
            {

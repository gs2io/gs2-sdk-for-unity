...
namespace Gs2.Gs2Showcase.Model
{
	...
	public class Namespace
	{
         ...
         *
         * @param queueNamespaceId 購入処理をジョブとして追加するキューのネームスペース のGRN
         * @return this
         */
         ...
         *
         * @param keyId 購入処理のスタンプシートで使用する暗号鍵GRN
         * @return this
         */
    ...
    {
        var match = Regex.Match(grn, "grn:gs2:(?<region>.*):(?<ownerId>.*):showcase:(?<namespaceName>.*)");
    ...
    )
    {
        ...
        public static Namespace FromDict(JsonData data)
        {
            return new Namespace()
                ...
                .WithLogSetting(data.Keys.Contains("logSetting") && data["logSetting"] != null ? Gs2.Gs2Showcase.Model.LogSetting.FromDict(data["logSetting"]) : null)

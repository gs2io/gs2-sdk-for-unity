...
{
	[Preserve]
	public class RestoreDataObjectByUserIdResult
	{
        /** データオブジェクト */
    	...
    	[Preserve]
        public static RestoreDataObjectByUserIdResult FromDict(JsonData data)
        {
            return new RestoreDataObjectByUserIdResult {

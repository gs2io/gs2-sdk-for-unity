...
{
	[Preserve]
	public class PrepareDownloadByUserIdAndDataObjectNameAndGenerationResult
	{
        /** データオブジェクト */
    	...
    	[Preserve]
        public static PrepareDownloadByUserIdAndDataObjectNameAndGenerationResult FromDict(JsonData data)
        {

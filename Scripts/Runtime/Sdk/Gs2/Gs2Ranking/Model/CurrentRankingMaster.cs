...
{
	[Preserve]
	public class CurrentRankingMaster : IComparable
	{
         ...
         * @return this
         */
        public CurrentRankingMaster WithNamespaceName(string namespaceName) {
    ...
    {
        var match = Regex.Match(grn, "grn:gs2:(?<region>.*):(?<ownerId>.*):ranking:(?<namespaceName>.*)");
    ...
    )
    {
    	...
    	[Preserve]
        public static CurrentRankingMaster FromDict(JsonData data)
        {
        ...
        {
            var other = obj as CurrentRankingMaster;
            var diff = 0;

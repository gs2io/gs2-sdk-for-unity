...
{
	[Preserve]
	public class CurrentMessageMaster : IComparable
	{
         ...
         * @return this
         */
        public CurrentMessageMaster WithNamespaceName(string namespaceName) {
         ...
         * @return this
         */
        public CurrentMessageMaster WithSettings(string settings) {
    ...
    )
    {
    	...
    	[Preserve]
        public static CurrentMessageMaster FromDict(JsonData data)
        {
        ...
        {
            var other = obj as CurrentMessageMaster;
            var diff = 0;

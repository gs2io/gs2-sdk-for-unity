...
namespace Gs2.Gs2Exchange
{
	public class Gs2ExchangeWebSocketClient : AbstractGs2Client
	{
        ...
        private class ExchangeByStampSheetTask : Gs2WebSocketSessionTask<Result.ExchangeByStampSheetResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("exchange");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("exchangeByStampSheet");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class AcquireTask : Gs2WebSocketSessionTask<Result.AcquireResult>
        {
        ...
        private class AcquireByUserIdTask : Gs2WebSocketSessionTask<Result.AcquireByUserIdResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("await");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("acquireByUserId");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class AcquireForceByUserIdTask : Gs2WebSocketSessionTask<Result.AcquireForceByUserIdResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("await");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("acquireForceByUserId");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class SkipTask : Gs2WebSocketSessionTask<Result.SkipResult>
        {
        ...
        private class SkipByUserIdTask : Gs2WebSocketSessionTask<Result.SkipByUserIdResult>
        {
        ...
        private class DeleteAwaitByStampTaskTask : Gs2WebSocketSessionTask<Result.DeleteAwaitByStampTaskResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("await");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("deleteAwaitByStampTask");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());

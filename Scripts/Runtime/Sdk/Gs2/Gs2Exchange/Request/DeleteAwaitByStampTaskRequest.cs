...
namespace Gs2.Gs2Exchange.Request
{
	[Preserve]
	[System.Serializable]
	public class DeleteAwaitByStampTaskRequest : Gs2Request<DeleteAwaitByStampTaskRequest>
	{
         ...
         * @return this
         */
        public DeleteAwaitByStampTaskRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static DeleteAwaitByStampTaskRequest FromDict(JsonData data)
        {

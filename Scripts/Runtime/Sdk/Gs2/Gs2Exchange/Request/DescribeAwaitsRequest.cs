...
namespace Gs2.Gs2Exchange.Request
{
	[Preserve]
	[System.Serializable]
	public class DescribeAwaitsRequest : Gs2Request<DescribeAwaitsRequest>
	{
         ...
         * @return this
         */
        public DescribeAwaitsRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public DescribeAwaitsRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static DescribeAwaitsRequest FromDict(JsonData data)
        {

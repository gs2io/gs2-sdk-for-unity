...
namespace Gs2.Gs2Exchange.Request
{
	...
	public class CreateAwaitByStampSheetRequest : Gs2Request<CreateAwaitByStampSheetRequest>
	{
         ...
         * @return this
         */
        public CreateAwaitByStampSheetRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static CreateAwaitByStampSheetRequest FromDict(JsonData data)
        {

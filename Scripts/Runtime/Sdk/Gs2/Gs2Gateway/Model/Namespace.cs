...
namespace Gs2.Gs2Gateway.Model
{
	...
	public class Namespace : IComparable
	{
        ...
        public void WriteJson(JsonWriter writer)
        {
            ...
            if(this.firebaseSecret != null)
            {
                ...
                writer.Write(this.firebaseSecret);
            }
    ...
    {
        var match = Regex.Match(grn, "grn:gs2:(?<region>.*):(?<ownerId>.*):gateway:(?<namespaceName>.*)");
    ...
    )
    {
        ...
        public int CompareTo(object obj)
        {
            ...
            {
                diff += firebaseSecret.CompareTo(other.firebaseSecret);
            }

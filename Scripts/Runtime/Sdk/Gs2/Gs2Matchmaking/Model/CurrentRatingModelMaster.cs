...
{
	[Preserve]
	public class CurrentRatingModelMaster : IComparable
	{
         ...
         * @return this
         */
        public CurrentRatingModelMaster WithNamespaceName(string namespaceName) {
    ...
    )
    {
    	...
    	[Preserve]
        public static CurrentRatingModelMaster FromDict(JsonData data)
        {
        ...
        {
            var other = obj as CurrentRatingModelMaster;
            var diff = 0;

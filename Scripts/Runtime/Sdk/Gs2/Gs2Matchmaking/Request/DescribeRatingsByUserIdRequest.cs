...
namespace Gs2.Gs2Matchmaking.Request
{
	...
	public class DescribeRatingsByUserIdRequest : Gs2Request<DescribeRatingsByUserIdRequest>
	{
         ...
         * @return this
         */
        public DescribeRatingsByUserIdRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public DescribeRatingsByUserIdRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static DescribeRatingsByUserIdRequest FromDict(JsonData data)
        {

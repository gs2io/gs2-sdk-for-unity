...
namespace Gs2.Gs2Dictionary.Request
{
	...
	public class AddEntriesByStampSheetRequest : Gs2Request<AddEntriesByStampSheetRequest>
	{
         ...
         * @return this
         */
        public AddEntriesByStampSheetRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static AddEntriesByStampSheetRequest FromDict(JsonData data)
        {

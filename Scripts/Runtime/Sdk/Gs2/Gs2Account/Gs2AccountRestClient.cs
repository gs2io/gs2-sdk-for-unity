...
namespace Gs2.Gs2Account
{
	public class Gs2AccountRestClient : AbstractGs2Client
	{
        ...
        private class DescribeAccountsTask : Gs2RestSessionTask<Result.DescribeAccountsResult>
        {
			private readonly Request.DescribeAccountsRequest _request;

			public DescribeAccountsTask(Request.DescribeAccountsRequest request, UnityAction<AsyncResult<Result.DescribeAccountsResult>> userCallback) : base(userCallback)
			{
				_request = request;
			}
		...
		{
			var task = new DescribeAccountsTask(request, callback);
			return Gs2RestSession.Execute(task);
        }
        ...
        private class UpdateTimeOffsetTask : Gs2RestSessionTask<Result.UpdateTimeOffsetResult>
        {
        ...
        private class GetAccountTask : Gs2RestSessionTask<Result.GetAccountResult>
        {
        ...
        private class AuthenticationTask : Gs2RestSessionTask<Result.AuthenticationResult>
        {
			private readonly Request.AuthenticationRequest _request;

			public AuthenticationTask(Request.AuthenticationRequest request, UnityAction<AsyncResult<Result.AuthenticationResult>> userCallback) : base(userCallback)
			{
				_request = request;
			}
		...
		{
			var task = new AuthenticationTask(request, callback);
			return Gs2RestSession.Execute(task);
        }

        private class DescribeTakeOversTask : Gs2RestSessionTask<Result.DescribeTakeOversResult>
        {
			private readonly Request.DescribeTakeOversRequest _request;

			public DescribeTakeOversTask(Request.DescribeTakeOversRequest request, UnityAction<AsyncResult<Result.DescribeTakeOversResult>> userCallback) : base(userCallback)
			{
				_request = request;
			}
		...
		{
			var task = new DescribeTakeOversTask(request, callback);
			return Gs2RestSession.Execute(task);
        }

        private class DescribeTakeOversByUserIdTask : Gs2RestSessionTask<Result.DescribeTakeOversByUserIdResult>
        {
			private readonly Request.DescribeTakeOversByUserIdRequest _request;

			public DescribeTakeOversByUserIdTask(Request.DescribeTakeOversByUserIdRequest request, UnityAction<AsyncResult<Result.DescribeTakeOversByUserIdResult>> userCallback) : base(userCallback)
			{
				_request = request;
			}
		...
		{
			var task = new DescribeTakeOversByUserIdTask(request, callback);
			return Gs2RestSession.Execute(task);
        }

        private class CreateTakeOverTask : Gs2RestSessionTask<Result.CreateTakeOverResult>
        {
        ...
        private class CreateTakeOverByUserIdTask : Gs2RestSessionTask<Result.CreateTakeOverByUserIdResult>
        {
        ...
        private class GetTakeOverTask : Gs2RestSessionTask<Result.GetTakeOverResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                url = url.Replace("{namespaceName}", !string.IsNullOrEmpty(_request.namespaceName) ? _request.namespaceName.ToString() : "null");
                url = url.Replace("{type}",_request.type != null ? _request.type.ToString() : "null");
        ...
        private class GetTakeOverByUserIdTask : Gs2RestSessionTask<Result.GetTakeOverByUserIdResult>
        {
        ...
        private class UpdateTakeOverTask : Gs2RestSessionTask<Result.UpdateTakeOverResult>
        {
        ...
        private class UpdateTakeOverByUserIdTask : Gs2RestSessionTask<Result.UpdateTakeOverByUserIdResult>
        {
        ...
        private class DeleteTakeOverTask : Gs2RestSessionTask<Result.DeleteTakeOverResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                if (_request.userIdentifier != null) {
                    queryStrings.Add(string.Format("{0}={1}", "userIdentifier", UnityWebRequest.EscapeURL(_request.userIdentifier)));
                }
                url += "?" + string.Join("&", queryStrings.ToArray());
        ...
        private class DeleteTakeOverByUserIdentifierTask : Gs2RestSessionTask<Result.DeleteTakeOverByUserIdentifierResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                url = url.Replace("{namespaceName}", !string.IsNullOrEmpty(_request.namespaceName) ? _request.namespaceName.ToString() : "null");
                url = url.Replace("{type}",_request.type != null ? _request.type.ToString() : "null");
                url = url.Replace("{userIdentifier}", !string.IsNullOrEmpty(_request.userIdentifier) ? _request.userIdentifier.ToString() : "null");
        ...
        private class DoTakeOverTask : Gs2RestSessionTask<Result.DoTakeOverResult>
        {

...
namespace Gs2.Gs2Friend.Request
{
	[Preserve]
	[System.Serializable]
	public class UnregisterBlackListByUserIdRequest : Gs2Request<UnregisterBlackListByUserIdRequest>
	{
         ...
         * @return this
         */
        public UnregisterBlackListByUserIdRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static UnregisterBlackListByUserIdRequest FromDict(JsonData data)
        {

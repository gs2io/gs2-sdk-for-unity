...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class AddReferenceOfItemSetByStampSheetRequest : Gs2Request<AddReferenceOfItemSetByStampSheetRequest>
	{
         ...
         * @return this
         */
        public AddReferenceOfItemSetByStampSheetRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static AddReferenceOfItemSetByStampSheetRequest FromDict(JsonData data)
        {

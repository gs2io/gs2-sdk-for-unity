...
{
	[Preserve]
	public class DescribeBillingActivitiesResult
	{
        /** 請求にまつわるアクティビティのリスト */
        public List<BillingActivity> items { set; get; }
    	...
    	[Preserve]
        public static DescribeBillingActivitiesResult FromDict(JsonData data)
        {

...
namespace Gs2.Gs2Enhance.Request
{
	...
	public class DirectEnhanceByStampSheetRequest : Gs2Request<DirectEnhanceByStampSheetRequest>
	{
         ...
         * @return this
         */
        public DirectEnhanceByStampSheetRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static DirectEnhanceByStampSheetRequest FromDict(JsonData data)
        {

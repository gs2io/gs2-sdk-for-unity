...
namespace Gs2.Gs2Friend.Request
{
	...
	public class GetReceiveRequestByUserIdRequest : Gs2Request<GetReceiveRequestByUserIdRequest>
	{
         ...
         * @return this
         */
        public GetReceiveRequestByUserIdRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static GetReceiveRequestByUserIdRequest FromDict(JsonData data)
        {

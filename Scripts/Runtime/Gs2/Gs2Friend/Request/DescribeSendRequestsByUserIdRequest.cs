...
namespace Gs2.Gs2Friend.Request
{
	...
	public class DescribeSendRequestsByUserIdRequest : Gs2Request<DescribeSendRequestsByUserIdRequest>
	{
         ...
         * @return this
         */
        public DescribeSendRequestsByUserIdRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static DescribeSendRequestsByUserIdRequest FromDict(JsonData data)
        {

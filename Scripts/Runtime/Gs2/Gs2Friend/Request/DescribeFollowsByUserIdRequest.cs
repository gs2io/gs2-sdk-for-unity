...
namespace Gs2.Gs2Friend.Request
{
	...
	public class DescribeFollowsByUserIdRequest : Gs2Request<DescribeFollowsByUserIdRequest>
	{
         ...
         * @return this
         */
        public DescribeFollowsByUserIdRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public DescribeFollowsByUserIdRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static DescribeFollowsByUserIdRequest FromDict(JsonData data)
        {

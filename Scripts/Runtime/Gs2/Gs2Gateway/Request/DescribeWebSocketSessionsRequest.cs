...
namespace Gs2.Gs2Gateway.Request
{
	...
	public class DescribeWebSocketSessionsRequest : Gs2Request<DescribeWebSocketSessionsRequest>
	{
         ...
         * @return this
         */
        public DescribeWebSocketSessionsRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public DescribeWebSocketSessionsRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static DescribeWebSocketSessionsRequest FromDict(JsonData data)
        {

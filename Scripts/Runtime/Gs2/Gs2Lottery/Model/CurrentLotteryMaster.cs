...
{
	[Preserve]
	public class CurrentLotteryMaster
	{
         ...
         * @return this
         */
        public CurrentLotteryMaster WithNamespaceName(string namespaceName) {
    ...
    {
        var match = Regex.Match(grn, "grn:gs2:(?<region>.*):(?<ownerId>.*):lottery:(?<namespaceName>.*)");
    ...
    )
    {
    	...
    	[Preserve]
        public static CurrentLotteryMaster FromDict(JsonData data)
        {

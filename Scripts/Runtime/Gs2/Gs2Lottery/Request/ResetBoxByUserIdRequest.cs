...
{
	[Preserve]
	public class ResetBoxByUserIdRequest : Gs2Request<ResetBoxByUserIdRequest>
	{
         ...
         * @return this
         */
        public ResetBoxByUserIdRequest WithLotteryName(string lotteryName) {
         ...
         * @return this
         */
        public ResetBoxByUserIdRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static ResetBoxByUserIdRequest FromDict(JsonData data)
        {

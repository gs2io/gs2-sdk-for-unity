...
namespace Gs2.Gs2Inventory.Request
{
	[Preserve]
	[System.Serializable]
	public class GetInventoryModelMasterRequest : Gs2Request<GetInventoryModelMasterRequest>
	{
    	...
    	[Preserve]
        public static GetInventoryModelMasterRequest FromDict(JsonData data)
        {

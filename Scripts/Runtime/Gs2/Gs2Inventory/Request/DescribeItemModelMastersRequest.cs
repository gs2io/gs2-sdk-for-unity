...
{
	[Preserve]
	public class DescribeItemModelMastersRequest : Gs2Request<DescribeItemModelMastersRequest>
	{
    	...
    	[Preserve]
        public static DescribeItemModelMastersRequest FromDict(JsonData data)
        {

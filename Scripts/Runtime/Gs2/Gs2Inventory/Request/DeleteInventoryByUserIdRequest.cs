...
{
	[Preserve]
	public class DeleteInventoryByUserIdRequest : Gs2Request<DeleteInventoryByUserIdRequest>
	{
    	...
    	[Preserve]
        public static DeleteInventoryByUserIdRequest FromDict(JsonData data)
        {

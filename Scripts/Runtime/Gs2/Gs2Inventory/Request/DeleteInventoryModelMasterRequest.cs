...
{
	[Preserve]
	public class DeleteInventoryModelMasterRequest : Gs2Request<DeleteInventoryModelMasterRequest>
	{
    	...
    	[Preserve]
        public static DeleteInventoryModelMasterRequest FromDict(JsonData data)
        {

...
namespace Gs2.Gs2News.Model
{
	...
	public class Namespace
	{
         ...
         * @return this
         */
        public Namespace WithLogSetting(Gs2.Gs2News.Model.LogSetting logSetting) {
    ...
    {
        var match = Regex.Match(grn, "grn:gs2:(?<region>.*):(?<ownerId>.*):news:(?<namespaceName>.*)");
    ...
    )
    {
        ...
        public static Namespace FromDict(JsonData data)
        {
            return new Namespace()
                ...
                .WithVersion(data.Keys.Contains("version") && data["version"] != null ? data["version"].ToString() : null)
                .WithLogSetting(data.Keys.Contains("logSetting") && data["logSetting"] != null ? Gs2.Gs2News.Model.LogSetting.FromDict(data["logSetting"]) : null)

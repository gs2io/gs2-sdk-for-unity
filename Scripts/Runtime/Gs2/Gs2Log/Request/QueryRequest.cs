...
{
	[Preserve]
	public class QueryRequest : Gs2Request<QueryRequest>
	{
         ...
         * @return this
         */
        public QueryRequest WithNamespaceName(string namespaceName) {
         ...
         * @return this
         */
        public QueryRequest WithService(string service) {
         ...
         * @return this
         */
        public QueryRequest WithMethod(string method) {
            this.method = method;
            return this;
        }
         ...
         * @return this
         */
        public QueryRequest WithUserId(string userId) {
            this.userId = userId;
            return this;
        }
         ...
         * @return this
         */
        public QueryRequest WithAction(string action) {
            this.action = action;
            return this;
        }
         ...
         * @return this
         */
        public QueryRequest WithPageToken(string pageToken) {
         ...
         * @return this
         */
        public QueryRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public QueryRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static QueryRequest FromDict(JsonData data)
        {

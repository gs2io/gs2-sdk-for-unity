...
namespace Gs2.Gs2Log.Request
{
	...
	public class CountExecuteStampTaskLogRequest : Gs2Request<CountExecuteStampTaskLogRequest>
	{
         ...
         * @return this
         */
        public CountExecuteStampTaskLogRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public CountExecuteStampTaskLogRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static CountExecuteStampTaskLogRequest FromDict(JsonData data)
        {

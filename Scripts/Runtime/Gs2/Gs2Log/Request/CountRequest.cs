...
{
	[Preserve]
	public class CountRequest : Gs2Request<CountRequest>
	{
         ...
         * @return this
         */
        public CountRequest WithNamespaceName(string namespaceName) {
         ...
         * @return this
         */
        public CountRequest WithService(bool? service) {
         ...
         * @return this
         */
        public CountRequest WithMethod(bool? method) {
            this.method = method;
            return this;
        }
         ...
         * @return this
         */
        public CountRequest WithUserId(bool? userId) {
            this.userId = userId;
            return this;
        }
         ...
         * @return this
         */
        public CountRequest WithAction(bool? action) {
            this.action = action;
            return this;
        }
         ...
         * @return this
         */
        public CountRequest WithPageToken(string pageToken) {
         ...
         * @return this
         */
        public CountRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public CountRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static CountRequest FromDict(JsonData data)
        {

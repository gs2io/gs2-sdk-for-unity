...
namespace Gs2.Gs2Log.Request
{
	...
	public class QueryExecuteStampSheetLogRequest : Gs2Request<QueryExecuteStampSheetLogRequest>
	{
         ...
         * @return this
         */
        public QueryExecuteStampSheetLogRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public QueryExecuteStampSheetLogRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static QueryExecuteStampSheetLogRequest FromDict(JsonData data)
        {

...
namespace Gs2.Gs2Schedule
{
	public class Gs2ScheduleWebSocketClient : AbstractGs2Client
	{
        ...
        private class DescribeEventMastersTask : Gs2WebSocketSessionTask<Result.DescribeEventMastersResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeEventMasters");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeTriggersTask : Gs2WebSocketSessionTask<Result.DescribeTriggersResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeTriggers");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeTriggersByUserIdTask : Gs2WebSocketSessionTask<Result.DescribeTriggersByUserIdResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("trigger");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeTriggersByUserId");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeEventsByUserIdTask : Gs2WebSocketSessionTask<Result.DescribeEventsByUserIdResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("event");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeEventsByUserId");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeRawEventsTask : Gs2WebSocketSessionTask<Result.DescribeRawEventsResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("event");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeRawEvents");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class ExportMasterTask : Gs2WebSocketSessionTask<Result.ExportMasterResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("schedule");
                jsonWriter.WritePropertyName("component");
                jsonWriter.Write("currentEventMaster");
                jsonWriter.WritePropertyName("function");
        ...
        private class GetCurrentEventMasterTask : Gs2WebSocketSessionTask<Result.GetCurrentEventMasterResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("currentEventMaster");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("getCurrentEventMaster");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class UpdateCurrentEventMasterTask : Gs2WebSocketSessionTask<Result.UpdateCurrentEventMasterResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("currentEventMaster");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("updateCurrentEventMaster");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class UpdateCurrentEventMasterFromGitHubTask : Gs2WebSocketSessionTask<Result.UpdateCurrentEventMasterFromGitHubResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("currentEventMaster");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("updateCurrentEventMasterFromGitHub");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());

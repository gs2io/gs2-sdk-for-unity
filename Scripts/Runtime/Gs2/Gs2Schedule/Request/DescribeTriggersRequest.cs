...
namespace Gs2.Gs2Schedule.Request
{
	...
	public class DescribeTriggersRequest : Gs2Request<DescribeTriggersRequest>
	{
         ...
         * @return this
         */
        public DescribeTriggersRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public DescribeTriggersRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static DescribeTriggersRequest FromDict(JsonData data)
        {

...
{
	[Preserve]
	public class DeleteCompletedQuestListByUserIdRequest : Gs2Request<DeleteCompletedQuestListByUserIdRequest>
	{
    	...
    	[Preserve]
        public static DeleteCompletedQuestListByUserIdRequest FromDict(JsonData data)
        {

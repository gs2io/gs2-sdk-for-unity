...
{
	[Preserve]
	public class DeleteQuestGroupModelMasterRequest : Gs2Request<DeleteQuestGroupModelMasterRequest>
	{
    	...
    	[Preserve]
        public static DeleteQuestGroupModelMasterRequest FromDict(JsonData data)
        {

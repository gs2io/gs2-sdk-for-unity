...
{
	[Preserve]
	public class DescribeRecoverIntervalTableMastersResult
	{
        /** スタミナ回復間隔テーブルマスターのリスト */
        public List<RecoverIntervalTableMaster> items { set; get; }
    	...
    	[Preserve]
        public static DescribeRecoverIntervalTableMastersResult FromDict(JsonData data)
        {

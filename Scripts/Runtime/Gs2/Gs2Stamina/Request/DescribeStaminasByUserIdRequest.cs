...
{
	[Preserve]
	public class DescribeStaminasByUserIdRequest : Gs2Request<DescribeStaminasByUserIdRequest>
	{
         ...
         * @return this
         */
        public DescribeStaminasByUserIdRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public DescribeStaminasByUserIdRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static DescribeStaminasByUserIdRequest FromDict(JsonData data)
        {

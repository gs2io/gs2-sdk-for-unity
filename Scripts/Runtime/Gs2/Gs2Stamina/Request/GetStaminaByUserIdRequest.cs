...
{
	[Preserve]
	public class GetStaminaByUserIdRequest : Gs2Request<GetStaminaByUserIdRequest>
	{
         ...
         * @return this
         */
        public GetStaminaByUserIdRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static GetStaminaByUserIdRequest FromDict(JsonData data)
        {

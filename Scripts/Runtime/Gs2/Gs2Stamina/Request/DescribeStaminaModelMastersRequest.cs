...
{
	[Preserve]
	public class DescribeStaminaModelMastersRequest : Gs2Request<DescribeStaminaModelMastersRequest>
	{
    	...
    	[Preserve]
        public static DescribeStaminaModelMastersRequest FromDict(JsonData data)
        {

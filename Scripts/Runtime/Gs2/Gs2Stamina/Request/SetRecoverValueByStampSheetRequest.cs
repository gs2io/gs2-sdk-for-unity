...
namespace Gs2.Gs2Stamina.Request
{
	...
	public class SetRecoverValueByStampSheetRequest : Gs2Request<SetRecoverValueByStampSheetRequest>
	{
         ...
         * @return this
         */
        public SetRecoverValueByStampSheetRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static SetRecoverValueByStampSheetRequest FromDict(JsonData data)
        {

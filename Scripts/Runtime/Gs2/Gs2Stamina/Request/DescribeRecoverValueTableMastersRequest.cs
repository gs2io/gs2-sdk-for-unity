...
{
	[Preserve]
	public class DescribeRecoverValueTableMastersRequest : Gs2Request<DescribeRecoverValueTableMastersRequest>
	{
         ...
         * @return this
         */
        public DescribeRecoverValueTableMastersRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
    	...
    	[Preserve]
        public static DescribeRecoverValueTableMastersRequest FromDict(JsonData data)
        {

...
namespace Gs2.Gs2Stamina.Request
{
	...
	public class RaiseMaxValueByStampSheetRequest : Gs2Request<RaiseMaxValueByStampSheetRequest>
	{
         ...
         * @return this
         */
        public RaiseMaxValueByStampSheetRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static RaiseMaxValueByStampSheetRequest FromDict(JsonData data)
        {

...
namespace Gs2.Gs2Stamina.Request
{
	...
	public class CreateStaminaModelMasterRequest : Gs2Request<CreateStaminaModelMasterRequest>
	{
         ...
         * @return this
         */
        public CreateStaminaModelMasterRequest WithRecoverIntervalTableId(string recoverIntervalTableId) {
         ...
         * @return this
         */
        public CreateStaminaModelMasterRequest WithRecoverValueTableId(string recoverValueTableId) {

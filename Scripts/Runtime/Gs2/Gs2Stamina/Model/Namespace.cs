	...
	public class Namespace
	{
        ...
        public static Namespace FromDict(JsonData data)
        {
            return new Namespace()
                ...
                .WithOverflowTriggerScriptId(data.Keys.Contains("overflowTriggerScriptId") && data["overflowTriggerScriptId"] != null ? (string) data["overflowTriggerScriptId"] : null)
                .WithOverflowTriggerNamespaceId(data.Keys.Contains("overflowTriggerNamespaceId") && data["overflowTriggerNamespaceId"] != null ? (string) data["overflowTriggerNamespaceId"] : null)

...
{
	[Preserve]
	public class DescribeDeadLetterJobsByUserIdRequest : Gs2Request<DescribeDeadLetterJobsByUserIdRequest>
	{
         ...
         * @return this
         */
        public DescribeDeadLetterJobsByUserIdRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public DescribeDeadLetterJobsByUserIdRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static DescribeDeadLetterJobsByUserIdRequest FromDict(JsonData data)
        {

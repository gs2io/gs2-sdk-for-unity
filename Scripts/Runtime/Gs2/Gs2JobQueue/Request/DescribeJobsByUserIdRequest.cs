...
namespace Gs2.Gs2JobQueue.Request
{
	...
	public class DescribeJobsByUserIdRequest : Gs2Request<DescribeJobsByUserIdRequest>
	{
         ...
         * @return this
         */
        public DescribeJobsByUserIdRequest WithUserId(string userId) {
            this.userId = userId;
            return this;
        }
         ...
         * @return this
         */
        public DescribeJobsByUserIdRequest WithPageToken(string pageToken) {
         ...
         * @return this
         */
        public DescribeJobsByUserIdRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public DescribeJobsByUserIdRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static DescribeJobsByUserIdRequest FromDict(JsonData data)
        {

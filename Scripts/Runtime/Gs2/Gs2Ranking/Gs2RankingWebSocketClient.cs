...
namespace Gs2.Gs2Ranking
{
	public class Gs2RankingWebSocketClient : AbstractGs2Client
	{
        ...
        private class DescribeCategoryModelsTask : Gs2WebSocketSessionTask<Result.DescribeCategoryModelsResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeCategoryModels");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeCategoryModelMastersTask : Gs2WebSocketSessionTask<Result.DescribeCategoryModelMastersResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeCategoryModelMasters");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeSubscribesByCategoryNameTask : Gs2WebSocketSessionTask<Result.DescribeSubscribesByCategoryNameResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeSubscribesByCategoryName");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeSubscribesByCategoryNameAndUserIdTask : Gs2WebSocketSessionTask<Result.DescribeSubscribesByCategoryNameAndUserIdResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("subscribe");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeSubscribesByCategoryNameAndUserId");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeRankingsTask : Gs2WebSocketSessionTask<Result.DescribeRankingsResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("ranking");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeRankings");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeRankingssByUserIdTask : Gs2WebSocketSessionTask<Result.DescribeRankingssByUserIdResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("ranking");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeRankingssByUserId");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeNearRankingsTask : Gs2WebSocketSessionTask<Result.DescribeNearRankingsResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("ranking");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeNearRankings");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class ExportMasterTask : Gs2WebSocketSessionTask<Result.ExportMasterResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("ranking");
                jsonWriter.WritePropertyName("component");
                jsonWriter.Write("currentRankingMaster");
                jsonWriter.WritePropertyName("function");
        ...
        private class GetCurrentRankingMasterTask : Gs2WebSocketSessionTask<Result.GetCurrentRankingMasterResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("currentRankingMaster");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("getCurrentRankingMaster");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class UpdateCurrentRankingMasterTask : Gs2WebSocketSessionTask<Result.UpdateCurrentRankingMasterResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("currentRankingMaster");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("updateCurrentRankingMaster");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class UpdateCurrentRankingMasterFromGitHubTask : Gs2WebSocketSessionTask<Result.UpdateCurrentRankingMasterFromGitHubResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("currentRankingMaster");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("updateCurrentRankingMasterFromGitHub");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());

...
{
	[Preserve]
	public class DescribeCategoryModelMastersResult
	{
        /** カテゴリマスターのリスト */
        public List<CategoryModelMaster> items { set; get; }
    	...
    	[Preserve]
        public static DescribeCategoryModelMastersResult FromDict(JsonData data)
        {

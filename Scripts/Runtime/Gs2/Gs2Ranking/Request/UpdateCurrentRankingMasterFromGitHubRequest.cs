...
namespace Gs2.Gs2Ranking.Request
{
	...
	public class UpdateCurrentRankingMasterFromGitHubRequest : Gs2Request<UpdateCurrentRankingMasterFromGitHubRequest>
	{
         ...
         * @return this
         */
        public UpdateCurrentRankingMasterFromGitHubRequest WithCheckoutSetting(Gs2.Gs2Ranking.Model.GitHubCheckoutSetting checkoutSetting) {
        ...
        public static UpdateCurrentRankingMasterFromGitHubRequest FromDict(JsonData data)
        {
            return new UpdateCurrentRankingMasterFromGitHubRequest {
                ...
                checkoutSetting = data.Keys.Contains("checkoutSetting") && data["checkoutSetting"] != null ? Gs2.Gs2Ranking.Model.GitHubCheckoutSetting.FromDict(data["checkoutSetting"]) : null,
            };
        }

...
namespace Gs2.Gs2Script.Model
{
	...
	public class Namespace
	{
         ...
         * @return this
         */
        public Namespace WithLogSetting(Gs2.Gs2Script.Model.LogSetting logSetting) {
    ...
    {
        var match = Regex.Match(grn, "grn:gs2:(?<region>.*):(?<ownerId>.*):script:(?<namespaceName>.*)");
    ...
    )
    {
        ...
        public static Namespace FromDict(JsonData data)
        {
            return new Namespace()
                ...
                .WithLogSetting(data.Keys.Contains("logSetting") && data["logSetting"] != null ? Gs2.Gs2Script.Model.LogSetting.FromDict(data["logSetting"]) : null)

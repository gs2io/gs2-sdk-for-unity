...
namespace Gs2.Gs2Formation.Request
{
	...
	public class AcquireActionToFormPropertiesByStampSheetRequest : Gs2Request<AcquireActionToFormPropertiesByStampSheetRequest>
	{
         ...
         * @return this
         */
        public AcquireActionToFormPropertiesByStampSheetRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static AcquireActionToFormPropertiesByStampSheetRequest FromDict(JsonData data)
        {

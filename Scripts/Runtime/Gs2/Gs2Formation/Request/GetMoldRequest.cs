...
{
	[Preserve]
	public class GetMoldRequest : Gs2Request<GetMoldRequest>
	{
         ...
         * @return this
         */
        public GetMoldRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static GetMoldRequest FromDict(JsonData data)
        {

...
namespace Gs2.Gs2Formation.Request
{
	...
	public class DescribeFormsByUserIdRequest : Gs2Request<DescribeFormsByUserIdRequest>
	{
         ...
         * @return this
         */
        public DescribeFormsByUserIdRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public DescribeFormsByUserIdRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static DescribeFormsByUserIdRequest FromDict(JsonData data)
        {

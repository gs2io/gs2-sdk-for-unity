...
{
	[Preserve]
	public class GetFormByUserIdRequest : Gs2Request<GetFormByUserIdRequest>
	{
         ...
         * @return this
         */
        public GetFormByUserIdRequest WithIndex(int? index) {
            this.index = index;
            return this;
        }
         ...
         * @return this
         */
        public GetFormByUserIdRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static GetFormByUserIdRequest FromDict(JsonData data)
        {

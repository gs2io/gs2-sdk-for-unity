...
{
	[Preserve]
	public class CurrentShowcaseMaster
	{
         ...
         * @return this
         */
        public CurrentShowcaseMaster WithNamespaceName(string namespaceName) {
    ...
    {
        var match = Regex.Match(grn, "grn:gs2:(?<region>.*):(?<ownerId>.*):showcase:(?<namespaceName>.*):currentShowcase");
    ...
    )
    {
    	...
    	[Preserve]
        public static CurrentShowcaseMaster FromDict(JsonData data)
        {

...
{
	[Preserve]
	public class DescribeSalesItemGroupMastersResult
	{
        /** 商品グループマスターのリスト */
        public List<SalesItemGroupMaster> items { set; get; }
    	...
    	[Preserve]
        public static DescribeSalesItemGroupMastersResult FromDict(JsonData data)
        {

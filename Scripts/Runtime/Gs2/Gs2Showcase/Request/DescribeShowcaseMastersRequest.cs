...
namespace Gs2.Gs2Showcase.Request
{
	...
	public class DescribeShowcaseMastersRequest : Gs2Request<DescribeShowcaseMastersRequest>
	{
         ...
         * @return this
         */
        public DescribeShowcaseMastersRequest WithPageToken(string pageToken) {
         ...
         * @return this
         */
        public DescribeShowcaseMastersRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
    	...
    	[Preserve]
        public static DescribeShowcaseMastersRequest FromDict(JsonData data)
        {

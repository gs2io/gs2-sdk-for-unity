...
{
	[Preserve]
	public class DescribeTakeOversByUserIdRequest : Gs2Request<DescribeTakeOversByUserIdRequest>
	{
    	...
    	[Preserve]
        public static DescribeTakeOversByUserIdRequest FromDict(JsonData data)
        {

...
{
	[Preserve]
	public class GetTakeOverRequest : Gs2Request<GetTakeOverRequest>
	{
         ...
         * @return this
         */
        public GetTakeOverRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static GetTakeOverRequest FromDict(JsonData data)
        {

...
{
	[Preserve]
	public class AddRankCapByStampSheetRequest : Gs2Request<AddRankCapByStampSheetRequest>
	{
         ...
         * @return this
         */
        public AddRankCapByStampSheetRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static AddRankCapByStampSheetRequest FromDict(JsonData data)
        {

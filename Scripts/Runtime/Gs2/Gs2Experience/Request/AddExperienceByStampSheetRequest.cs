...
{
	[Preserve]
	public class AddExperienceByStampSheetRequest : Gs2Request<AddExperienceByStampSheetRequest>
	{
    	...
    	[Preserve]
        public static AddExperienceByStampSheetRequest FromDict(JsonData data)
        {

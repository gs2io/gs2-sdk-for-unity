...
{
	[Preserve]
	public class DescribeWalletsByUserIdRequest : Gs2Request<DescribeWalletsByUserIdRequest>
	{
         ...
         * @return this
         */
        public DescribeWalletsByUserIdRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public DescribeWalletsByUserIdRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static DescribeWalletsByUserIdRequest FromDict(JsonData data)
        {

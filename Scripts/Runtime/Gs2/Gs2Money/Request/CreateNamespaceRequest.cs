	...
	public class CreateNamespaceRequest : Gs2Request<CreateNamespaceRequest>
	{
        ...
        public static CreateNamespaceRequest FromDict(JsonData data)
        {
            return new CreateNamespaceRequest {
                ...
                shareFree = data.Keys.Contains("shareFree") && data["shareFree"] != null ? (bool?) data["shareFree"] : null,
                currency = data.Keys.Contains("currency") && data["currency"] != null ? (string) data["currency"] : null,

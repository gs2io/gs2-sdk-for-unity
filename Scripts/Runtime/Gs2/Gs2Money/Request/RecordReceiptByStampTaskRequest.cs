...
{
	[Preserve]
	public class RecordReceiptByStampTaskRequest : Gs2Request<RecordReceiptByStampTaskRequest>
	{
    	...
    	[Preserve]
        public static RecordReceiptByStampTaskRequest FromDict(JsonData data)
        {

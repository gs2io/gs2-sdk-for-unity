	...
	public class Namespace
	{
        ...
        public static Namespace FromDict(JsonData data)
        {
            return new Namespace()
                ...
                .WithPriority(data.Keys.Contains("priority") && data["priority"] != null ? (string) data["priority"] : null)
                .WithShareFree(data.Keys.Contains("shareFree") && data["shareFree"] != null ? (bool?) data["shareFree"] : null)
                .WithCurrency(data.Keys.Contains("currency") && data["currency"] != null ? (string) data["currency"] : null)
                .WithAppleKey(data.Keys.Contains("appleKey") && data["appleKey"] != null ? (string) data["appleKey"] : null)
                .WithGoogleKey(data.Keys.Contains("googleKey") && data["googleKey"] != null ? (string) data["googleKey"] : null)
                .WithEnableFakeReceipt(data.Keys.Contains("enableFakeReceipt") && data["enableFakeReceipt"] != null ? (bool?) data["enableFakeReceipt"] : null)
                ...
                .WithBalance(data.Keys.Contains("balance") && data["balance"] != null ? (double?) data["balance"] : null)

...
{
	[Preserve]
	public class DescribeDistributorModelMastersResult
	{
        /** 配信設定マスターのリスト */
        public List<DistributorModelMaster> items { set; get; }
    	...
    	[Preserve]
        public static DescribeDistributorModelMastersResult FromDict(JsonData data)
        {

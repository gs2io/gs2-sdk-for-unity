...
namespace Gs2.Gs2Distributor
{
	public class Gs2DistributorWebSocketClient : AbstractGs2Client
	{
        ...
        private class DescribeDistributorModelMastersTask : Gs2WebSocketSessionTask<Result.DescribeDistributorModelMastersResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("distributor");
                jsonWriter.WritePropertyName("component");
                jsonWriter.Write("distributorModelMaster");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeDistributorModelMasters");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class CreateDistributorModelMasterTask : Gs2WebSocketSessionTask<Result.CreateDistributorModelMasterResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("distributorModelMaster");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("createDistributorModelMaster");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class GetDistributorModelMasterTask : Gs2WebSocketSessionTask<Result.GetDistributorModelMasterResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("distributorModelMaster");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("getDistributorModelMaster");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class UpdateDistributorModelMasterTask : Gs2WebSocketSessionTask<Result.UpdateDistributorModelMasterResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("distributorModelMaster");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("updateDistributorModelMaster");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DeleteDistributorModelMasterTask : Gs2WebSocketSessionTask<Result.DeleteDistributorModelMasterResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("distributorModelMaster");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("deleteDistributorModelMaster");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeDistributorModelsTask : Gs2WebSocketSessionTask<Result.DescribeDistributorModelsResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("distributor");
                jsonWriter.WritePropertyName("component");
                jsonWriter.Write("distributorModel");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeDistributorModels");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class GetDistributorModelTask : Gs2WebSocketSessionTask<Result.GetDistributorModelResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("distributorModel");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("getDistributorModel");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class ExportMasterTask : Gs2WebSocketSessionTask<Result.ExportMasterResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("distributor");
                jsonWriter.WritePropertyName("component");
                jsonWriter.Write("currentDistributorMaster");
                jsonWriter.WritePropertyName("function");
        ...
        private class GetCurrentDistributorMasterTask : Gs2WebSocketSessionTask<Result.GetCurrentDistributorMasterResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("currentDistributorMaster");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("getCurrentDistributorMaster");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class UpdateCurrentDistributorMasterTask : Gs2WebSocketSessionTask<Result.UpdateCurrentDistributorMasterResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("currentDistributorMaster");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("updateCurrentDistributorMaster");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class UpdateCurrentDistributorMasterFromGitHubTask : Gs2WebSocketSessionTask<Result.UpdateCurrentDistributorMasterFromGitHubResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("currentDistributorMaster");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("updateCurrentDistributorMasterFromGitHub");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DistributeTask : Gs2WebSocketSessionTask<Result.DistributeResult>
        {
        ...
        private class RunStampSheetTask : Gs2WebSocketSessionTask<Result.RunStampSheetResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("distribute");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("runStampSheet");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());

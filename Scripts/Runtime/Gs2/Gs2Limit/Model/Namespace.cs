...
namespace Gs2.Gs2Limit.Model
{
    ...
    {
        var match = Regex.Match(grn, "grn:gs2:(?<region>.*):(?<ownerId>.*):limit:(?<namespaceName>.*)");
    ...
    )
    {
        ...
        public static Namespace FromDict(JsonData data)
        {
            return new Namespace()
                ...
                .WithLogSetting(data.Keys.Contains("logSetting") && data["logSetting"] != null ? Gs2.Gs2Limit.Model.LogSetting.FromDict(data["logSetting"]) : null)

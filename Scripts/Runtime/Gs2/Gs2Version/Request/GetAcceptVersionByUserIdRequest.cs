...
namespace Gs2.Gs2Version.Request
{
	...
	public class GetAcceptVersionByUserIdRequest : Gs2Request<GetAcceptVersionByUserIdRequest>
	{
         ...
         * @return this
         */
        public GetAcceptVersionByUserIdRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static GetAcceptVersionByUserIdRequest FromDict(JsonData data)
        {

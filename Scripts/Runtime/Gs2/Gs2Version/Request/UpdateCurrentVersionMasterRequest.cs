...
{
	[Preserve]
	public class UpdateCurrentVersionMasterRequest : Gs2Request<UpdateCurrentVersionMasterRequest>
	{
    	...
    	[Preserve]
        public static UpdateCurrentVersionMasterRequest FromDict(JsonData data)
        {

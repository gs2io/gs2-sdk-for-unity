...
{
	[Preserve]
	public class GetAcceptVersionRequest : Gs2Request<GetAcceptVersionRequest>
	{
         ...
         * @return this
         */
        public GetAcceptVersionRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static GetAcceptVersionRequest FromDict(JsonData data)
        {

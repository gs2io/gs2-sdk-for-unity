	...
	public class UpdateCurrentVersionMasterFromGitHubRequest : Gs2Request<UpdateCurrentVersionMasterFromGitHubRequest>
	{
        ...
        public static UpdateCurrentVersionMasterFromGitHubRequest FromDict(JsonData data)
        {
            return new UpdateCurrentVersionMasterFromGitHubRequest {
                ...
                checkoutSetting = data.Keys.Contains("checkoutSetting") && data["checkoutSetting"] != null ? Gs2.Gs2Version.Model.GitHubCheckoutSetting.FromDict(data["checkoutSetting"]) : null,
            };
        }

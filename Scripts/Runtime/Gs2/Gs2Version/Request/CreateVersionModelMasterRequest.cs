...
namespace Gs2.Gs2Version.Request
{
	...
	public class CreateVersionModelMasterRequest : Gs2Request<CreateVersionModelMasterRequest>
	{
         ...
         * @return this
         */
        public CreateVersionModelMasterRequest WithWarningVersion(Version_ warningVersion) {
         ...
         * @return this
         */
        public CreateVersionModelMasterRequest WithErrorVersion(Version_ errorVersion) {
         ...
         * @return this
         */
        public CreateVersionModelMasterRequest WithCurrentVersion(Version_ currentVersion) {

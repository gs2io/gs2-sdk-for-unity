...
{
	[Preserve]
	public class DescribeAcceptVersionsRequest : Gs2Request<DescribeAcceptVersionsRequest>
	{
         ...
         * @return this
         */
        public DescribeAcceptVersionsRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public DescribeAcceptVersionsRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static DescribeAcceptVersionsRequest FromDict(JsonData data)
        {

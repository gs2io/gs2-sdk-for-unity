...
{
	[Preserve]
	public class DescribeVersionModelMastersResult
	{
        /** バージョンマスターのリスト */
        public List<VersionModelMaster> items { set; get; }
    	...
    	[Preserve]
        public static DescribeVersionModelMastersResult FromDict(JsonData data)
        {

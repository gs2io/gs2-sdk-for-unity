...
{
	[Preserve]
	public class PrepareDownloadRequest : Gs2Request<PrepareDownloadRequest>
	{
         ...
         * @return this
         */
        public PrepareDownloadRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static PrepareDownloadRequest FromDict(JsonData data)
        {

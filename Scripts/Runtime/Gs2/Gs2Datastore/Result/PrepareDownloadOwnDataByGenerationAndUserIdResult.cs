...
{
	[Preserve]
	public class PrepareDownloadOwnDataByGenerationAndUserIdResult
	{
        /** データオブジェクト */
    	...
    	[Preserve]
        public static PrepareDownloadOwnDataByGenerationAndUserIdResult FromDict(JsonData data)
        {
            return new PrepareDownloadOwnDataByGenerationAndUserIdResult {

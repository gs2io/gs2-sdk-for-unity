...
{
	[Preserve]
	public class DownloadByGenerationAndUserIdResult
	{
        /** データオブジェクト */
    	...
    	[Preserve]
        public static DownloadByGenerationAndUserIdResult FromDict(JsonData data)
        {
            return new DownloadByGenerationAndUserIdResult {

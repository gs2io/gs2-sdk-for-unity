	...
	public class Gs2MissionWebSocketClient : AbstractGs2Client
	{
        ...
        private class ExportMasterTask : Gs2WebSocketSessionTask<Result.ExportMasterResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("mission");
                jsonWriter.WritePropertyName("component");
                jsonWriter.Write("currentMissionMaster");
                jsonWriter.WritePropertyName("function");
        ...
        private class GetCurrentMissionMasterTask : Gs2WebSocketSessionTask<Result.GetCurrentMissionMasterResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("currentMissionMaster");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("getCurrentMissionMaster");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class UpdateCurrentMissionMasterTask : Gs2WebSocketSessionTask<Result.UpdateCurrentMissionMasterResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("currentMissionMaster");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("updateCurrentMissionMaster");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class UpdateCurrentMissionMasterFromGitHubTask : Gs2WebSocketSessionTask<Result.UpdateCurrentMissionMasterFromGitHubResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("currentMissionMaster");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("updateCurrentMissionMasterFromGitHub");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeCompletesTask : Gs2WebSocketSessionTask<Result.DescribeCompletesResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("mission");
                jsonWriter.WritePropertyName("component");
                jsonWriter.Write("complete");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeCompletes");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeCompletesByUserIdTask : Gs2WebSocketSessionTask<Result.DescribeCompletesByUserIdResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("complete");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeCompletesByUserId");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class CompleteTask : Gs2WebSocketSessionTask<Result.CompleteResult>
        {
        ...
        private class CompleteByUserIdTask : Gs2WebSocketSessionTask<Result.CompleteByUserIdResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("complete");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("completeByUserId");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class ReceiveByUserIdTask : Gs2WebSocketSessionTask<Result.ReceiveByUserIdResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("complete");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("receiveByUserId");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class GetCompleteTask : Gs2WebSocketSessionTask<Result.GetCompleteResult>
        {
        ...
        private class GetCompleteByUserIdTask : Gs2WebSocketSessionTask<Result.GetCompleteByUserIdResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("complete");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("getCompleteByUserId");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DeleteCompleteByUserIdTask : Gs2WebSocketSessionTask<Result.DeleteCompleteByUserIdResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("complete");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("deleteCompleteByUserId");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class ReceiveByStampTaskTask : Gs2WebSocketSessionTask<Result.ReceiveByStampTaskResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("complete");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("receiveByStampTask");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());

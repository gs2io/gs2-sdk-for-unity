...
namespace Gs2.Gs2Mission.Request
{
	...
	public class DescribeCompletesByUserIdRequest : Gs2Request<DescribeCompletesByUserIdRequest>
	{
         ...
         * @return this
         */
        public DescribeCompletesByUserIdRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public DescribeCompletesByUserIdRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static DescribeCompletesByUserIdRequest FromDict(JsonData data)
        {

...
namespace Gs2.Gs2Mission.Request
{
	...
	public class DescribeCountersRequest : Gs2Request<DescribeCountersRequest>
	{
         ...
         * @return this
         */
        public DescribeCountersRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public DescribeCountersRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static DescribeCountersRequest FromDict(JsonData data)
        {

...
{
	[Preserve]
	public class DeleteMissionGroupModelMasterRequest : Gs2Request<DeleteMissionGroupModelMasterRequest>
	{
    	...
    	[Preserve]
        public static DeleteMissionGroupModelMasterRequest FromDict(JsonData data)
        {

...
{
	[Preserve]
	public class DescribeCompletesRequest : Gs2Request<DescribeCompletesRequest>
	{
         ...
         * @return this
         */
        public DescribeCompletesRequest WithLimit(long? limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return this
         */
        public DescribeCompletesRequest WithDuplicationAvoider(string duplicationAvoider) {
    	...
    	[Preserve]
        public static DescribeCompletesRequest FromDict(JsonData data)
        {

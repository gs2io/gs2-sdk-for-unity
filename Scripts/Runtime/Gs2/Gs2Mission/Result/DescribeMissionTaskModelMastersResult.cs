...
{
	[Preserve]
	public class DescribeMissionTaskModelMastersResult
	{
        /** ミッションタスクマスターのリスト */
        public List<MissionTaskModelMaster> items { set; get; }
    	...
    	[Preserve]
        public static DescribeMissionTaskModelMastersResult FromDict(JsonData data)
        {

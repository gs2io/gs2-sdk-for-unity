...
namespace Gs2.Gs2Inbox.Request
{
	[Preserve]
	[System.Serializable]
	public class ReceiveGlobalMessageByUserIdRequest : Gs2Request<ReceiveGlobalMessageByUserIdRequest>
	{
    	...
    	[Preserve]
        public static ReceiveGlobalMessageByUserIdRequest FromDict(JsonData data)
        {

...
namespace Gs2.Gs2Inbox.Request
{
	[Preserve]
	[System.Serializable]
	public class DescribeGlobalMessageMastersRequest : Gs2Request<DescribeGlobalMessageMastersRequest>
	{
    	...
    	[Preserve]
        public static DescribeGlobalMessageMastersRequest FromDict(JsonData data)
        {

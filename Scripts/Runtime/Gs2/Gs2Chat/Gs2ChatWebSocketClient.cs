...
namespace Gs2.Gs2Chat
{
	public class Gs2ChatWebSocketClient : AbstractGs2Client
	{
        ...
        private class DescribeRoomsTask : Gs2WebSocketSessionTask<Result.DescribeRoomsResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeRooms");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeMessagesTask : Gs2WebSocketSessionTask<Result.DescribeMessagesResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                if (_request.startAt != null)
                {
                    ...
                    jsonWriter.Write(_request.startAt.ToString());
                }
                if (_request.limit != null)
                {
                    jsonWriter.WritePropertyName("limit");
        ...
        private class DescribeSubscribesTask : Gs2WebSocketSessionTask<Result.DescribeSubscribesResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeSubscribes");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeSubscribesByUserIdTask : Gs2WebSocketSessionTask<Result.DescribeSubscribesByUserIdResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("subscribe");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeSubscribesByUserId");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeSubscribesByRoomNameTask : Gs2WebSocketSessionTask<Result.DescribeSubscribesByRoomNameResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("subscribe");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeSubscribesByRoomName");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());

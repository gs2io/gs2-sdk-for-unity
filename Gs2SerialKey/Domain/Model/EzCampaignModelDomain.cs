...
namespace Gs2.Unity.Gs2SerialKey.Domain.Model
{
    ...
    public partial class EzCampaignModelDomain {
        ...
        public IFuture<Gs2.Unity.Gs2SerialKey.Model.EzCampaignModel> Model()
        {
            return ModelFuture();
        }
        #endif
        ...
        public async UniTask<Gs2.Unity.Gs2SerialKey.Model.EzCampaignModel> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2SerialKey.Model.EzCampaignModel> ModelAsync()
            #endif
        {
            ...
            return Gs2.Unity.Gs2SerialKey.Model.EzCampaignModel.FromModel(
                item
            );
        }
        #endif
        ...
        public IFuture<Gs2.Unity.Gs2SerialKey.Model.EzCampaignModel> ModelFuture()
        {
            IEnumerator Impl(Gs2Future<Gs2.Unity.Gs2SerialKey.Model.EzCampaignModel> self)
            {
                ...
                self.OnComplete(Gs2.Unity.Gs2SerialKey.Model.EzCampaignModel.FromModel(
                    item
                ));
            }
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2SerialKey.Model.EzCampaignModel> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2SerialKey.Model.EzCampaignModel.FromModel(
                    item
                ));
            });
        }
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2SerialKey.Model.EzCampaignModel> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2SerialKey.Model.EzCampaignModel> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2SerialKey.Model.EzCampaignModel> callback)
            #endif
        {

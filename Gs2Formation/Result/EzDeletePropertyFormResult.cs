...
namespace Gs2.Unity.Gs2Formation.Result
{
	...
	public class EzDeletePropertyFormResult
	{
		[SerializeField]
        ...
        public static EzDeletePropertyFormResult FromModel(Gs2.Gs2Formation.Result.DeletePropertyFormResult model)
        {
            return new EzDeletePropertyFormResult {

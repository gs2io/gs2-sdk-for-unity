...
namespace Gs2.Unity.Gs2Formation.Domain.Model
{
    ...
    public partial class EzUserGameSessionDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Formation.Model.EzMold> MoldsAsync(
        )
        {
            var it = _domain.MoldsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Formation.Model.EzMold.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Formation.Model.EzPropertyForm> PropertyFormsAsync(
              string propertyFormModelName
        )
        {
            var it = _domain.PropertyFormsAsync(
            ...
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Formation.Model.EzPropertyForm.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        public void InvalidatePropertyForms(
            ...
            this._domain.InvalidatePropertyForms(
                propertyFormModelName
            );
        }

...
namespace Gs2.Unity.Gs2Formation.Domain.Model
{
    ...
    public partial class EzPropertyFormModelDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2Formation.Model.EzPropertyFormModel> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Formation.Model.EzPropertyFormModel> ModelAsync()
            #endif
        {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Unity.Gs2Formation.Model.EzPropertyFormModel> ModelFuture()
        {
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Formation.Model.EzPropertyFormModel> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Formation.Model.EzPropertyFormModel> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Formation.Model.EzPropertyFormModel> callback)
            #endif
        {

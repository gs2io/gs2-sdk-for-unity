    ...
    public partial class EzFormGameSessionDomain {
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Formation.Model.EzForm> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2Formation.Model.EzForm.FromModel(
                    item
                ));
            });
        }
        ...
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Formation.Model.EzForm> callback)
        {
            ...
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Formation.Model.EzForm> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Formation.Model.EzForm> callback)
            #endif
        {

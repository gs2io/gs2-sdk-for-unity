...
namespace Gs2.Unity.Gs2Formation.Domain.Model
{
    ...
    public partial class EzMoldGameSessionDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Formation.Model.EzForm> FormsAsync(
        )
        {
            var it = _domain.FormsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Formation.Model.EzForm.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        public async UniTask<Gs2.Unity.Gs2Formation.Model.EzMold> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Formation.Model.EzMold> ModelAsync()
            #endif
        {

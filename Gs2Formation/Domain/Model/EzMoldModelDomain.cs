...
namespace Gs2.Unity.Gs2Formation.Domain.Model
{
    ...
    public partial class EzMoldModelDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2Formation.Model.EzMoldModel> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Formation.Model.EzMoldModel> ModelAsync()
            #endif
        {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Unity.Gs2Formation.Model.EzMoldModel> ModelFuture()
        {
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Formation.Model.EzMoldModel> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2Formation.Model.EzMoldModel.FromModel(
                    item
                ));
            });
        }
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Formation.Model.EzMoldModel> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Formation.Model.EzMoldModel> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Formation.Model.EzMoldModel> callback)
            #endif
        {

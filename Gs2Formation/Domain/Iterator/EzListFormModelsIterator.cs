...
namespace Gs2.Unity.Gs2Formation.Domain.Iterator
{
    ...
    public class EzDescribeFormModelsIterator : Gs2Iterator<Gs2.Unity.Gs2Formation.Model.EzFormModel> {
        ...
        protected override IEnumerator Next(
            Action<Gs2.Unity.Gs2Formation.Model.EzFormModel> callback
        )
        {
            yield return _iterator;
            callback.Invoke(_iterator.Current == null ? null : Gs2.Unity.Gs2Formation.Model.EzFormModel.FromModel(_iterator.Current));
        }

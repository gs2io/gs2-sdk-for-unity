...
namespace Gs2.Unity.Gs2Formation.Domain.Iterator
{
    ...
    public class EzListPropertyFormModelsIterator : Gs2Iterator<Gs2.Unity.Gs2Formation.Model.EzPropertyFormModel>
    {
        ...
        public EzListPropertyFormModelsIterator(
        ...
        )
        {
            ...
            _it = _domain.PropertyFormModels(
            );
        }

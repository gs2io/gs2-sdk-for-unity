...
namespace Gs2.Unity.Gs2Mission.Domain.Iterator
{
    ...
    public class EzDescribeMissionGroupModelsIterator : Gs2Iterator<Gs2.Unity.Gs2Mission.Model.EzMissionGroupModel> {
        ...
        public EzDescribeMissionGroupModelsIterator(
            Gs2.Gs2Mission.Domain.Iterator.DescribeMissionGroupModelsIterator iterator
        ) {
        ...
        protected override IEnumerator Next(
            Action<AsyncResult<Gs2.Unity.Gs2Mission.Model.EzMissionGroupModel>> callback
        )
        {
            yield return _iterator;
            callback.Invoke(new AsyncResult<Gs2.Unity.Gs2Mission.Model.EzMissionGroupModel>(
                _iterator.Current == null ? null : Gs2.Unity.Gs2Mission.Model.EzMissionGroupModel.FromModel(_iterator.Current),
                _iterator.Error
            ));
        }

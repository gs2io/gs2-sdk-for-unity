...
namespace Gs2.Unity.Gs2Mission.Domain.Model
{
    ...
    public partial class EzUserGameSessionDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Mission.Model.EzComplete> CompletesAsync(
        )
        {
            var it = _domain.CompletesAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Mission.Model.EzComplete.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Mission.Model.EzCounter> CountersAsync(
        )
        {
            var it = _domain.CountersAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Mission.Model.EzCounter.FromModel(it.Current);
                }
            }
            finally
            {

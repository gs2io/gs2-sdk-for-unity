...
namespace Gs2.Unity.Gs2Mission.Domain.Model
{
    ...
    public partial class EzMissionGroupModelDomain {
        ...
        {
            return new Gs2.Unity.Gs2Mission.Domain.Iterator.EzListMissionTaskModelsIterator(
                this._domain,
                this._connection
            );
        }
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Mission.Model.EzMissionTaskModel> MissionTaskModelsAsync(
        )
        {
            var it = _domain.MissionTaskModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Mission.Model.EzMissionTaskModel.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        public async UniTask<Gs2.Unity.Gs2Mission.Model.EzMissionGroupModel> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Mission.Model.EzMissionGroupModel> ModelAsync()
            #endif
        {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Unity.Gs2Mission.Model.EzMissionGroupModel> ModelFuture()
        {
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Mission.Model.EzMissionGroupModel> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Mission.Model.EzMissionGroupModel> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Mission.Model.EzMissionGroupModel> callback)
            #endif
        {

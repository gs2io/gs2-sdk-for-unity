...
namespace Gs2.Unity.Gs2Mission.Domain.Model
{
    ...
    public partial class EzCompleteDomain {
        private readonly Gs2.Gs2Mission.Domain.Model.CompleteDomain _domain;
        ...
        public EzCompleteDomain(
            Gs2.Gs2Mission.Domain.Model.CompleteDomain domain,
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Mission.Model.EzComplete> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(Gs2.Unity.Gs2Mission.Model.EzComplete.FromModel(
                    item
                ));
            });
        }

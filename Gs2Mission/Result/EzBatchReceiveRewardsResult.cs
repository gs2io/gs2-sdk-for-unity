...
namespace Gs2.Unity.Gs2Mission.Result
{
	...
	public class EzBatchReceiveRewardsResult
	{
		[SerializeField]
        ...
        public static EzBatchReceiveRewardsResult FromModel(Gs2.Gs2Mission.Result.BatchCompleteResult model)
        {
            return new EzBatchReceiveRewardsResult {

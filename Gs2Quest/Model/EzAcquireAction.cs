...
namespace Gs2.Unity.Gs2Quest.Model
{
	...
	public class EzAcquireAction
	{
        ...
        public Gs2.Gs2Quest.Model.AcquireAction ToModel()
        {
            return new Gs2.Gs2Quest.Model.AcquireAction {
                Action = Action,
                Request = Request,
            };
        }

        public static EzAcquireAction FromModel(Gs2.Gs2Quest.Model.AcquireAction model)
        {

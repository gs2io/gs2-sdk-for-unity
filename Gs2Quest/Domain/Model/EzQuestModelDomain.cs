...
namespace Gs2.Unity.Gs2Quest.Domain.Model
{
    ...
    public partial class EzQuestModelDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2Quest.Model.EzQuestModel> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Quest.Model.EzQuestModel> ModelAsync()
            #endif
        {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Unity.Gs2Quest.Model.EzQuestModel> ModelFuture()
        {
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Quest.Model.EzQuestModel> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2Quest.Model.EzQuestModel.FromModel(
                    item
                ));
            });
        }
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Quest.Model.EzQuestModel> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Quest.Model.EzQuestModel> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Quest.Model.EzQuestModel> callback)
            #endif
        {

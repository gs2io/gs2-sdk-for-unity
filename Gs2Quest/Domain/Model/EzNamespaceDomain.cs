...
namespace Gs2.Unity.Gs2Quest.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        ...
        {
            return new Gs2.Unity.Gs2Quest.Domain.Iterator.EzListQuestGroupsIterator(
                this._domain,
                this._connection
            );
        }
            ...
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Unity.Gs2Quest.Model.EzQuestGroupModel> QuestGroupModelsAsync(
        )
        {
            return UniTaskAsyncEnumerable.Create<Gs2.Unity.Gs2Quest.Model.EzQuestGroupModel>(async (writer, token) =>
            {
                var it = _domain.QuestGroupModelsAsync(
                ).GetAsyncEnumerator();
                try
                {
                    while(
                        await this._connection.RunIteratorAsync(
                            ...
                            () => {
                                it = _domain.QuestGroupModelsAsync(
                                ).GetAsyncEnumerator();
                            }
                        )
                    )
                    {
                        await writer.YieldAsync(it.Current == null ? null : Gs2.Unity.Gs2Quest.Model.EzQuestGroupModel.FromModel(it.Current));
                    }
                }
                finally
                {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Quest.Model.EzQuestGroupModel> QuestGroupModelsAsync(
        )
        {
            var it = _domain.QuestGroupModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Quest.Model.EzQuestGroupModel.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        public ulong SubscribeQuestGroupModels(
            Action<Gs2.Unity.Gs2Quest.Model.EzQuestGroupModel[]> callback
        ) {
            return this._domain.SubscribeQuestGroupModels(
                items => {
                    callback.Invoke(items.Select(Gs2.Unity.Gs2Quest.Model.EzQuestGroupModel.FromModel).ToArray());
                }
            );
        }

...
namespace Gs2.Unity.Gs2Quest.Domain.Model
{
    ...
    public partial class EzQuestGroupModelDomain {
        ...
        {
            return new Gs2.Unity.Gs2Quest.Domain.Iterator.EzListQuestsIterator(
                this._domain,
                this._connection
            );
        }
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Quest.Model.EzQuestModel> QuestModelsAsync(
        )
        {
            var it = _domain.QuestModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Quest.Model.EzQuestModel.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        public async UniTask<Gs2.Unity.Gs2Quest.Model.EzQuestGroupModel> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Quest.Model.EzQuestGroupModel> ModelAsync()
            #endif
        {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Unity.Gs2Quest.Model.EzQuestGroupModel> ModelFuture()
        {
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Quest.Model.EzQuestGroupModel> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2Quest.Model.EzQuestGroupModel.FromModel(
                    item
                ));
            });
        }
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Quest.Model.EzQuestGroupModel> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Quest.Model.EzQuestGroupModel> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Quest.Model.EzQuestGroupModel> callback)
            #endif
        {

...
namespace Gs2.Unity.UiKit.Gs2Quest.Fetcher
{
    ...
    [AddComponentMenu("GS2 UIKit/Quest/Gs2QuestQuestListFetcher")]
    public partial class Gs2QuestQuestListFetcher : MonoBehaviour
    {
            ...
            while (true)
            {
                    ...
                    questGroup != null)
                {
                    ...
                    else
                    {
                        ...
                        {
                            Quests = Array.Empty<EzQuestModel>();
                        }
                        else
                        {
                            Quests = future.Result.Quests.ToArray();
                        }
    ...
    public partial class Gs2QuestQuestListFetcher
    {
    ...
    public partial class Gs2QuestQuestListFetcher
    {
        public EzQuestModel[] Quests { get; private set; }

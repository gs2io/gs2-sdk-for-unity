...
namespace Gs2.Unity.Gs2Inbox.Model
{
	...
	public class EzAcquireAction
	{
        ...
        public Gs2.Gs2Inbox.Model.AcquireAction ToModel()
        {
            return new Gs2.Gs2Inbox.Model.AcquireAction {
                Action = Action,
                Request = Request,
            };
        }

        public static EzAcquireAction FromModel(Gs2.Gs2Inbox.Model.AcquireAction model)
        {

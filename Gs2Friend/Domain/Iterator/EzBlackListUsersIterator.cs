...
namespace Gs2.Unity.Gs2Friend.Domain.Iterator
{
    ...
    public class EzBlackListUsersIterator : Gs2Iterator<string>
    {
        ...
        public EzBlackListUsersIterator(
        ...
        protected override IEnumerator Next(Action<AsyncResult<string>> callback)
        {
            yield return _connection.RunIterator(
                ...
                () =>
                {
                    return _it = _domain.BlackListUsers(
                    );
                }
            );
            callback.Invoke(
                new AsyncResult<string>(
                    _it.Current == null ? null : _it.Current,
                    _it.Error
                )
            );
        }

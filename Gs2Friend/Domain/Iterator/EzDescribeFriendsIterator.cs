...
namespace Gs2.Unity.Gs2Friend.Domain.Iterator
{
    ...
    public class EzDescribeFriendsIterator : Gs2Iterator<Gs2.Unity.Gs2Friend.Model.EzFriendUser> {
        ...
        public EzDescribeFriendsIterator(
            Gs2.Gs2Friend.Domain.Iterator.DescribeFriendsIterator iterator
        ) {
        ...
        protected override IEnumerator Next(
            Action<AsyncResult<Gs2.Unity.Gs2Friend.Model.EzFriendUser>> callback
        )
        {
            yield return _iterator;
            callback.Invoke(new AsyncResult<Gs2.Unity.Gs2Friend.Model.EzFriendUser>(
                _iterator.Current == null ? null : Gs2.Unity.Gs2Friend.Model.EzFriendUser.FromModel(_iterator.Current),
                _iterator.Error
            ));
        }

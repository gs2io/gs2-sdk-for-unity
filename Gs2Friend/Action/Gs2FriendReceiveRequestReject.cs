...
{
    [AddComponentMenu("GS2 UIKit/Friend/Gs2FriendReceiveRequestReject")]
    public partial class Gs2FriendReceiveRequestReject : MonoBehaviour
    {
    ...
    public partial class Gs2FriendReceiveRequestReject
    {
    ...
    {
        [Serializable]
        private class RejectCompleteEvent : UnityEvent<Gs2FriendReceiveRequestReject>
        {
        ...
        public event UnityAction<Gs2FriendReceiveRequestReject> OnRejectComplete
        {
            add => onRejectComplete.AddListener(value);
            remove => onRejectComplete.RemoveListener(value);
        }

...
{
    [AddComponentMenu("GS2 UIKit/Friend/Gs2FriendSendRequest")]
    public partial class Gs2FriendSendRequest : MonoBehaviour
    {
    ...
    public partial class Gs2FriendSendRequest
    {
    ...
    {
        [Serializable]
        private class SendRequestCompleteEvent : UnityEvent<Gs2FriendSendRequest>
        {
        ...
        public event UnityAction<Gs2FriendSendRequest> OnSendRequestComplete
        {

...
namespace Gs2.Unity.UiKit.Gs2Friend.Fetcher
{
    ...
    [AddComponentMenu("GS2 UIKit/Friend/Gs2FriendSendRequestFetcher")]
    public partial class Gs2FriendSendRequestFetcher : MonoBehaviour
    {
                ...
                {
                    {
                        var it = _clientHolder.Gs2.Friend.Namespace(
                            sendFriendRequest.Namespace.namespaceName
                        ).Me(
                        ...
                        SendRequest = friendRequests.FirstOrDefault(v => sendFriendRequest.userId == v.TargetUserId);
                        Fetched = true;
                    }
                }
    ...
    public partial class Gs2FriendSendRequestFetcher
    {
    ...
    public partial class Gs2FriendSendRequestFetcher
    {
        public EzFriendRequest SendRequest { get; private set; }

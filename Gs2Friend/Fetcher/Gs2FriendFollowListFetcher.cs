...
namespace Gs2.Unity.UiKit.Gs2Friend.Fetcher
{
    ...
    [AddComponentMenu("GS2 UIKit/Friend/Gs2FriendFollowListFetcher")]
    public partial class Gs2FriendFollowListFetcher : MonoBehaviour
    {
                ...
                {
                    {
                        ...
                        var follows = new List<EzFollowUser>();
                        while (it.HasNext())
                        {
    ...
    public partial class Gs2FriendFollowListFetcher
    {
    ...
    public partial class Gs2FriendFollowListFetcher
    {
        public List<EzFollowUser> Follows { get; private set; }

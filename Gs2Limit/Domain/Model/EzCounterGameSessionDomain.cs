    ...
    public partial class EzCounterGameSessionDomain {
        ...
        )
        {
            IEnumerator Impl(Gs2Future<Gs2.Unity.Gs2Limit.Domain.Model.EzCounterGameSessionDomain> self)
            {
                ...
                self.OnComplete(new Gs2.Unity.Gs2Limit.Domain.Model.EzCounterGameSessionDomain(
                    future.Result,
                    this._gameSession,
                    this._connection
                ));
        ...
        public async UniTask<Gs2.Unity.Gs2Limit.Domain.Model.EzCounterGameSessionDomain> CountUpAsync(
            #else
        public async Task<Gs2.Unity.Gs2Limit.Domain.Model.EzCounterGameSessionDomain> CountUpAsync(
            #endif
            int? countUpValue = null,
            int? maxValue = null
        ) {
        ...
        public async UniTask<Gs2.Unity.Gs2Limit.Model.EzCounter> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Limit.Model.EzCounter> ModelAsync()
            #endif
        {
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Limit.Model.EzCounter> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2Limit.Model.EzCounter.FromModel(
                    item
                ));
            });
        }
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Limit.Model.EzCounter> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Limit.Model.EzCounter> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Limit.Model.EzCounter> callback)
            #endif
        {

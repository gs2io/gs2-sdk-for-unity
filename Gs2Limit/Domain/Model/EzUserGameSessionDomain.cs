...
namespace Gs2.Unity.Gs2Limit.Domain.Model
{
    ...
    public partial class EzUserGameSessionDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Limit.Model.EzCounter> CountersAsync(
              string? limitName = null
        )
        {
            var it = _domain.CountersAsync(
            ...
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Limit.Model.EzCounter.FromModel(it.Current);
                }
            }
            finally
            {

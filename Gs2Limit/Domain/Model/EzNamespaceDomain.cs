...
namespace Gs2.Unity.Gs2Limit.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Limit.Model.EzLimitModel> LimitModelsAsync(
        )
        {
            var it = _domain.LimitModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Limit.Model.EzLimitModel.FromModel(it.Current);
                }
            }
            finally
            {

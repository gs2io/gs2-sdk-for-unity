...
namespace Gs2.Unity.Gs2Lottery.Domain.Iterator
{
    ...
    public class EzDescribeLotteryModelsIterator : Gs2Iterator<Gs2.Unity.Gs2Lottery.Model.EzLotteryModel> {
        ...
        protected override IEnumerator Next(
            Action<AsyncResult<Gs2.Unity.Gs2Lottery.Model.EzLotteryModel>> callback
        )
        {
            yield return _iterator;
            callback.Invoke(new AsyncResult<Gs2.Unity.Gs2Lottery.Model.EzLotteryModel>(
                _iterator.Current == null ? null : Gs2.Unity.Gs2Lottery.Model.EzLotteryModel.FromModel(_iterator.Current),
                _iterator.Error
            ));
        }

...
namespace Gs2.Unity.Gs2Lottery.Domain.Model
{
    ...
    public partial class EzProbabilityGameSessionDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2Lottery.Model.EzProbability> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Lottery.Model.EzProbability> ModelAsync()
            #endif
        {
            ...
            return Gs2.Unity.Gs2Lottery.Model.EzProbability.FromModel(
                item
            );
        }
        #endif
        ...
        public IFuture<Gs2.Unity.Gs2Lottery.Model.EzProbability> ModelFuture()
        {
            IEnumerator Impl(Gs2Future<Gs2.Unity.Gs2Lottery.Model.EzProbability> self)
            {
                ...
                self.OnComplete(Gs2.Unity.Gs2Lottery.Model.EzProbability.FromModel(
                    item
                ));
            }
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Lottery.Model.EzProbability> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2Lottery.Model.EzProbability.FromModel(
                    item
                ));
            });
        }
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Lottery.Model.EzProbability> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Lottery.Model.EzProbability> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Lottery.Model.EzProbability> callback)
            #endif
        {

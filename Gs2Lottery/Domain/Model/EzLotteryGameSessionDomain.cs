...
namespace Gs2.Unity.Gs2Lottery.Domain.Model
{
    ...
    public partial class EzLotteryGameSessionDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Lottery.Model.EzProbability> ProbabilitiesAsync(
        )
        {
            var it = _domain.ProbabilitiesAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Lottery.Model.EzProbability.FromModel(it.Current);
                }
            }
            finally
            {

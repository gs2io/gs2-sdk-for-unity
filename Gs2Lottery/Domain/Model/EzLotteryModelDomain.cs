...
namespace Gs2.Unity.Gs2Lottery.Domain.Model
{
    ...
    public partial class EzLotteryModelDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2Lottery.Model.EzLotteryModel> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Lottery.Model.EzLotteryModel> ModelAsync()
            #endif
        {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Unity.Gs2Lottery.Model.EzLotteryModel> ModelFuture()
        {
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Lottery.Model.EzLotteryModel> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Lottery.Model.EzLotteryModel> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Lottery.Model.EzLotteryModel> callback)
            #endif
        {

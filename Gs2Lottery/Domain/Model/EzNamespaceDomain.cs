...
namespace Gs2.Unity.Gs2Lottery.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Lottery.Model.EzLotteryModel> LotteryModelsAsync(
        )
        {
            var it = _domain.LotteryModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Lottery.Model.EzLotteryModel.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        public void InvalidateLotteryModels(
        ) {
            this._domain.InvalidateLotteryModels(
            );
        }

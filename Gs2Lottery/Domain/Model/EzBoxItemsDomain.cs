...
namespace Gs2.Unity.Gs2Lottery.Domain.Model
{
    ...
    public partial class EzBoxItemsDomain {
        private readonly Gs2.Gs2Lottery.Domain.Model.BoxItemsDomain _domain;
        private readonly Gs2.Unity.Util.Profile _profile;
        public string NamespaceName => _domain?.NamespaceName;
        public string UserId => _domain?.UserId;
        public string PrizeTableName => _domain?.PrizeTableName;

        public EzBoxItemsDomain(
            Gs2.Gs2Lottery.Domain.Model.BoxItemsDomain domain,

...
namespace Gs2.Unity.Gs2Inventory.Result
{
	...
	public class EzListItemsResult
	{
		[SerializeField]
        ...
        public static EzListItemsResult FromModel(Gs2.Gs2Inventory.Result.DescribeItemSetsResult model)
        {
            return new EzListItemsResult {

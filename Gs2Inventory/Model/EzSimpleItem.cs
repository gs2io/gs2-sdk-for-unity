...
namespace Gs2.Unity.Gs2Inventory.Model
{
	...
	public class EzSimpleItem
	{
        ...
        public Gs2.Gs2Inventory.Model.SimpleItem ToModel()
        {
        ...
        public static EzSimpleItem FromModel(Gs2.Gs2Inventory.Model.SimpleItem model)
        {
            return new EzSimpleItem {

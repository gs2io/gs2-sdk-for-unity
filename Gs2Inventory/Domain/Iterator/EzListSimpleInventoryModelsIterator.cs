...
namespace Gs2.Unity.Gs2Inventory.Domain.Iterator
{
    ...
    public class EzListSimpleInventoryModelsIterator : Gs2Iterator<Gs2.Unity.Gs2Inventory.Model.EzSimpleInventoryModel>
    {
        ...
        public EzListSimpleInventoryModelsIterator(
        ...
        )
        {
            ...
            _it = _domain.SimpleInventoryModels(
            );
        }

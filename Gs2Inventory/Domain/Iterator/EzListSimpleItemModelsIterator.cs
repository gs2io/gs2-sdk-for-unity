...
namespace Gs2.Unity.Gs2Inventory.Domain.Iterator
{
    ...
    public class EzListSimpleItemModelsIterator : Gs2Iterator<Gs2.Unity.Gs2Inventory.Model.EzSimpleItemModel>
    {
        ...
        public EzListSimpleItemModelsIterator(

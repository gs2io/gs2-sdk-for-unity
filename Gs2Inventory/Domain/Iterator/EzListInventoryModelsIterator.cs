...
namespace Gs2.Unity.Gs2Inventory.Domain.Iterator
{
    ...
    public class EzListInventoryModelsIterator : Gs2Iterator<Gs2.Unity.Gs2Inventory.Model.EzInventoryModel>
    {
        ...
        public EzListInventoryModelsIterator(

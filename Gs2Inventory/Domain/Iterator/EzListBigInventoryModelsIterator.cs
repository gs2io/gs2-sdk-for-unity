...
namespace Gs2.Unity.Gs2Inventory.Domain.Iterator
{
    ...
    public class EzListBigInventoryModelsIterator : Gs2Iterator<Gs2.Unity.Gs2Inventory.Model.EzBigInventoryModel>
    {
        ...
        public EzListBigInventoryModelsIterator(
        ...
        )
        {
            ...
            _it = _domain.BigInventoryModels(
            );
        }

...
namespace Gs2.Unity.Gs2Inventory.Domain.Model
{
    ...
    public partial class EzBigInventoryGameSessionDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Inventory.Model.EzBigItem> BigItemsAsync(
        )
        {
            var it = _domain.BigItemsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Inventory.Model.EzBigItem.FromModel(it.Current);
                }
            }
            finally
            {

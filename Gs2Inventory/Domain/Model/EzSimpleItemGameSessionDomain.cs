...
namespace Gs2.Unity.Gs2Inventory.Domain.Model
{
    ...
    public partial class EzSimpleItemGameSessionDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2Inventory.Domain.Model.EzSimpleItemGameSessionDomain> GetSimpleItemWithSignatureAsync(
            #else
        public async Task<Gs2.Unity.Gs2Inventory.Domain.Model.EzSimpleItemGameSessionDomain> GetSimpleItemWithSignatureAsync(
            #endif
            string keyId = null
        ) {
        ...
        public async UniTask<Gs2.Unity.Gs2Inventory.Model.EzSimpleItem> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Inventory.Model.EzSimpleItem> ModelAsync()
            #endif
        {
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Inventory.Model.EzSimpleItem> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2Inventory.Model.EzSimpleItem.FromModel(
                    item
                ));
            });
        }
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Inventory.Model.EzSimpleItem> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Inventory.Model.EzSimpleItem> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Inventory.Model.EzSimpleItem> callback)
            #endif
        {

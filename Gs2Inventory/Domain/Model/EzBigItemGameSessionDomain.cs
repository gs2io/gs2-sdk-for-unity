...
namespace Gs2.Unity.Gs2Inventory.Domain.Model
{
    ...
    public partial class EzBigItemGameSessionDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        [Obsolete("The name has been changed to ConsumeBigItemFuture.")]
        public IFuture<Gs2.Unity.Gs2Inventory.Domain.Model.EzBigItemGameSessionDomain> ConsumeBigItem(
            string consumeCount
        )
        {
            return ConsumeBigItemFuture(
                consumeCount
            );
        }

        public IFuture<Gs2.Unity.Gs2Inventory.Domain.Model.EzBigItemGameSessionDomain> ConsumeBigItemFuture(
            string consumeCount
        )
        {
            IEnumerator Impl(Gs2Future<Gs2.Unity.Gs2Inventory.Domain.Model.EzBigItemGameSessionDomain> self)
            {
                ...
                self.OnComplete(new Gs2.Unity.Gs2Inventory.Domain.Model.EzBigItemGameSessionDomain(
                    future.Result,
                    this._gameSession,
                    this._connection
                ));
        ...
        public async UniTask<Gs2.Unity.Gs2Inventory.Domain.Model.EzBigItemGameSessionDomain> ConsumeBigItemAsync(
            #else
        public async Task<Gs2.Unity.Gs2Inventory.Domain.Model.EzBigItemGameSessionDomain> ConsumeBigItemAsync(
            #endif
            string consumeCount
        ) {
        ...
        public async UniTask<Gs2.Unity.Gs2Inventory.Model.EzBigItem> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Inventory.Model.EzBigItem> ModelAsync()
            #endif
        {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Unity.Gs2Inventory.Model.EzBigItem> ModelFuture()
        {
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Inventory.Model.EzBigItem> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2Inventory.Model.EzBigItem.FromModel(
                    item
                ));
            });
        }
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Inventory.Model.EzBigItem> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Inventory.Model.EzBigItem> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Inventory.Model.EzBigItem> callback)
            #endif
        {

...
namespace Gs2.Unity.Gs2Inventory.Domain.Model
{
    ...
    public partial class EzSimpleInventoryGameSessionDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2Inventory.Domain.Model.EzSimpleItemGameSessionDomain[]> ConsumeSimpleItemsAsync(
            #else
        public async Task<Gs2.Unity.Gs2Inventory.Domain.Model.EzSimpleItemGameSessionDomain[]> ConsumeSimpleItemsAsync(
            #endif
            Gs2.Unity.Gs2Inventory.Model.EzConsumeCount[] consumeCounts
        ) {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Inventory.Model.EzSimpleItem> SimpleItemsAsync(
        )
        {
            var it = _domain.SimpleItemsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Inventory.Model.EzSimpleItem.FromModel(it.Current);
                }
            }
            finally
            {

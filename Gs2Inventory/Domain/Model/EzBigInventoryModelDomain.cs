...
namespace Gs2.Unity.Gs2Inventory.Domain.Model
{
    ...
    public partial class EzBigInventoryModelDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Inventory.Model.EzBigItemModel> BigItemModelsAsync(
        )
        {
            var it = _domain.BigItemModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Inventory.Model.EzBigItemModel.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        public void InvalidateBigItemModels(
            ...
            this._domain.InvalidateBigItemModels(
            );
        }
        ...
        public async UniTask<Gs2.Unity.Gs2Inventory.Model.EzBigInventoryModel> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Inventory.Model.EzBigInventoryModel> ModelAsync()
            #endif
        {

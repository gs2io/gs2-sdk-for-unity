...
namespace Gs2.Unity.Gs2Inventory.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Inventory.Model.EzInventoryModel> InventoryModelsAsync(
        )
        {
            var it = _domain.InventoryModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Inventory.Model.EzInventoryModel.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Inventory.Model.EzSimpleInventoryModel> SimpleInventoryModelsAsync(
        )
        {
            var it = _domain.SimpleInventoryModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Inventory.Model.EzSimpleInventoryModel.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Inventory.Model.EzBigInventoryModel> BigInventoryModelsAsync(
        )
        {
            var it = _domain.BigInventoryModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Inventory.Model.EzBigInventoryModel.FromModel(it.Current);
                }
            }
            finally
            {

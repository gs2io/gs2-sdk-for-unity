...
namespace Gs2.Unity.Gs2Inventory.Domain.Model
{
    ...
    public partial class EzInventoryModelDomain {
        ...
        {
            return new Gs2.Unity.Gs2Inventory.Domain.Iterator.EzListItemModelsIterator(
                this._domain,
                this._connection
            );
        }
        ...
        )
        {
                ...
                try
                {
                    while(
                        await this._connection.RunIteratorAsync(
                            ...
                            () => {
                                it = _domain.ItemModelsAsync(
                                ).GetAsyncEnumerator();
                            }
                        )
                    )
                    {
                        await writer.YieldAsync(it.Current == null ? null : Gs2.Unity.Gs2Inventory.Model.EzItemModel.FromModel(it.Current));
                    }
                }
                finally
                {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Inventory.Model.EzItemModel> ItemModelsAsync(
        )
        {
            var it = _domain.ItemModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Inventory.Model.EzItemModel.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        public ulong SubscribeItemModels(
            Action<Gs2.Unity.Gs2Inventory.Model.EzItemModel[]> callback
        ) {
            return this._domain.SubscribeItemModels(
                items => {
                    callback.Invoke(items.Select(Gs2.Unity.Gs2Inventory.Model.EzItemModel.FromModel).ToArray());
                }
            );
        }
        ...
        public void UnsubscribeItemModels(
            ...
            this._domain.UnsubscribeItemModels(
                callbackId
            );
        }
        ...
        public async UniTask<Gs2.Unity.Gs2Inventory.Model.EzInventoryModel> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Inventory.Model.EzInventoryModel> ModelAsync()
            #endif
        {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Unity.Gs2Inventory.Model.EzInventoryModel> ModelFuture()
        {
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Inventory.Model.EzInventoryModel> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2Inventory.Model.EzInventoryModel.FromModel(
                    item
                ));
            });
        }
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Inventory.Model.EzInventoryModel> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Inventory.Model.EzInventoryModel> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Inventory.Model.EzInventoryModel> callback)
            #endif
        {

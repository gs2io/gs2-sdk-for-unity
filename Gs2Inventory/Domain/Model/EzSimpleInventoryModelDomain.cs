...
namespace Gs2.Unity.Gs2Inventory.Domain.Model
{
    ...
    public partial class EzSimpleInventoryModelDomain {
        ...
        {
            return new Gs2.Unity.Gs2Inventory.Domain.Iterator.EzListSimpleItemModelsIterator(
                this._domain,
                this._connection
            );
        }
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Inventory.Model.EzSimpleItemModel> SimpleItemModelsAsync(
        )
        {
            var it = _domain.SimpleItemModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Inventory.Model.EzSimpleItemModel.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        public ulong SubscribeSimpleItemModels(
            Action<Gs2.Unity.Gs2Inventory.Model.EzSimpleItemModel[]> callback
        ) {
            return this._domain.SubscribeSimpleItemModels(
                items => {
                    callback.Invoke(items.Select(Gs2.Unity.Gs2Inventory.Model.EzSimpleItemModel.FromModel).ToArray());
                }
            );
        }

        public void UnsubscribeSimpleItemModels(
            ulong callbackId
        ) {
        ...
        public void InvalidateSimpleItemModels(
        ) {
            this._domain.InvalidateSimpleItemModels(
            );
        }
        ...
        public async UniTask<Gs2.Unity.Gs2Inventory.Model.EzSimpleInventoryModel> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Inventory.Model.EzSimpleInventoryModel> ModelAsync()
            #endif
        {
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Inventory.Model.EzSimpleInventoryModel> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2Inventory.Model.EzSimpleInventoryModel.FromModel(
                    item
                ));
            });
        }
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Inventory.Model.EzSimpleInventoryModel> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Inventory.Model.EzSimpleInventoryModel> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Inventory.Model.EzSimpleInventoryModel> callback)
            #endif
        {

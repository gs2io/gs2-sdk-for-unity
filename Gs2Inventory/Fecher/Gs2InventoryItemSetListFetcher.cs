...
namespace Gs2.Unity.UiKit.Gs2Inventory.Fetcher
{
    ...
    [AddComponentMenu("GS2 UIKit/Inventory/Gs2InventoryItemSetListFetcher")]
    public partial class Gs2InventoryItemSetListFetcher : MonoBehaviour
    {
                ...
                {
                    {
                        ...
                        var itemModels = new List<EzItemModel>();
                        while (it.HasNext())
                        {
                    ...
                    }
                    {
                        ...
                        var itemModels = new List<EzItemSet>();
                        while (it.HasNext())
                        {
                            yield return it.Next();
                            if (it.Error != null)
    ...
    public partial class Gs2InventoryItemSetListFetcher
    {
    ...
    public partial class Gs2InventoryItemSetListFetcher
    {
        public List<EzItemModel> ItemModels { get; private set; }

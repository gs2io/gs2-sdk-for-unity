...
namespace Gs2.Unity.Gs2Enchant.Domain.Model
{
    ...
    public partial class EzUserGameSessionDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Enchant.Model.EzBalanceParameterStatus> BalanceParameterStatusesAsync(
              string? parameterName = null
        )
        {
            var it = _domain.BalanceParameterStatusesAsync(
            ...
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Enchant.Model.EzBalanceParameterStatus.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        public void InvalidateBalanceParameterStatuses(
            ...
            this._domain.InvalidateBalanceParameterStatuses(
                parameterName
            );
        }
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Enchant.Model.EzRarityParameterStatus> RarityParameterStatusesAsync(
              string? parameterName = null
        )
        {
            var it = _domain.RarityParameterStatusesAsync(
            ...
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Enchant.Model.EzRarityParameterStatus.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        public void InvalidateRarityParameterStatuses(
            ...
            this._domain.InvalidateRarityParameterStatuses(
                parameterName
            );
        }

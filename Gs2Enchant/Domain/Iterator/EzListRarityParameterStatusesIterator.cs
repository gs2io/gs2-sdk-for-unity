...
namespace Gs2.Unity.Gs2Enchant.Domain.Iterator
{
    ...
    public class EzListRarityParameterStatusesIterator : Gs2Iterator<Gs2.Unity.Gs2Enchant.Model.EzRarityParameterStatus>
    {
        ...
        public EzListRarityParameterStatusesIterator(
        ...
        )
        {
            ...
            _it = _domain.RarityParameterStatuses(
                parameterName
            );
        }

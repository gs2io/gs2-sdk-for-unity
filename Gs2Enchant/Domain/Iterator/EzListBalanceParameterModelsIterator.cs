...
namespace Gs2.Unity.Gs2Enchant.Domain.Iterator
{
    ...
    public class EzListBalanceParameterModelsIterator : Gs2Iterator<Gs2.Unity.Gs2Enchant.Model.EzBalanceParameterModel>
    {
        ...
        public EzListBalanceParameterModelsIterator(
        ...
        )
        {
            ...
            _it = _domain.BalanceParameterModels(
            );
        }

...
namespace Gs2.Unity.Gs2Buff.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Buff.Model.EzBuffEntryModel> BuffEntryModelsAsync(
        )
        {
            var it = _domain.BuffEntryModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Buff.Model.EzBuffEntryModel.FromModel(it.Current);
                }
            }
            finally
            {

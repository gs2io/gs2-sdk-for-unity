...
namespace Gs2.Unity.UiKit.Gs2Experience.Fetcher
{
    ...
    [AddComponentMenu("GS2 UIKit/Experience/Gs2ExperienceExperienceListFetcher")]
    public partial class Gs2ExperienceExperienceListFetcher : MonoBehaviour
    {
        private IEnumerator Fetch()
        {
            ...
            while (true)
            {
                    ...
                    Namespace != null)
                {
                    ...
                    var experienceModels = new List<EzExperienceModel>();
                    while (it.HasNext())
                    {
    ...
    public partial class Gs2ExperienceExperienceListFetcher
    {
    ...
    public partial class Gs2ExperienceExperienceListFetcher
    {
        public List<EzExperienceModel> ExperienceModels { get; private set; }

...
namespace Gs2.Unity.Gs2Experience.Domain.Model
{
    ...
    public partial class EzUserGameSessionDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Experience.Model.EzStatus> StatusesAsync(
              string? experienceName = null
        )
        {
            var it = _domain.StatusesAsync(
            ...
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Experience.Model.EzStatus.FromModel(it.Current);
                }
            }
            finally
            {

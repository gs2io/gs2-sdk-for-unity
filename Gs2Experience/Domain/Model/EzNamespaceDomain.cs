...
namespace Gs2.Unity.Gs2Experience.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        ...
        {
            return new Gs2.Unity.Gs2Experience.Domain.Iterator.EzListExperienceModelsIterator(
                this._domain,
                this._connection
            );
        }
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Experience.Model.EzExperienceModel> ExperienceModelsAsync(
        )
        {
            var it = _domain.ExperienceModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Experience.Model.EzExperienceModel.FromModel(it.Current);
                }
            }
            finally
            {

...
namespace Gs2.Unity.Gs2SkillTree.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2SkillTree.Model.EzNodeModel> NodeModelsAsync(
        )
        {
            var it = _domain.NodeModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2SkillTree.Model.EzNodeModel.FromModel(it.Current);
                }
            }
            finally
            {

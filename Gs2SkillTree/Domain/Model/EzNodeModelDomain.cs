...
namespace Gs2.Unity.Gs2SkillTree.Domain.Model
{
    ...
    public partial class EzNodeModelDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2SkillTree.Model.EzNodeModel> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2SkillTree.Model.EzNodeModel> ModelAsync()
            #endif
        {
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2SkillTree.Model.EzNodeModel> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2SkillTree.Model.EzNodeModel> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2SkillTree.Model.EzNodeModel> callback)
            #endif
        {

...
namespace Gs2.Unity.Gs2SkillTree.Model
{
	...
	public class EzConfig
	{
        ...
        public Gs2.Gs2SkillTree.Model.Config ToModel()
        {
            return new Gs2.Gs2SkillTree.Model.Config {
                Key = Key,
                Value = Value,
            };
        }

        public static EzConfig FromModel(Gs2.Gs2SkillTree.Model.Config model)
        {
            return new EzConfig {

...
namespace Gs2.Gs2Account
{
	public class Gs2AccountWebSocketClient : AbstractGs2Client
	{
        ...
        private class DescribeAccountsTask : Gs2WebSocketSessionTask<Result.DescribeAccountsResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("account");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeAccounts");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class AuthenticationTask : Gs2WebSocketSessionTask<Result.AuthenticationResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("account");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("authentication");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeTakeOversTask : Gs2WebSocketSessionTask<Result.DescribeTakeOversResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeTakeOvers");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());
        ...
        private class DescribeTakeOversByUserIdTask : Gs2WebSocketSessionTask<Result.DescribeTakeOversByUserIdResult>
        {
            ...
            protected override IEnumerator ExecuteImpl(Gs2Session gs2Session)
            {
                ...
                jsonWriter.Write("takeOver");
                jsonWriter.WritePropertyName("function");
                jsonWriter.Write("describeTakeOversByUserId");
                jsonWriter.WritePropertyName("contentType");
                jsonWriter.Write("application/json");
                jsonWriter.WritePropertyName("requestId");
                jsonWriter.Write(Gs2SessionTaskId.ToString());

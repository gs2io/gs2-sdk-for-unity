...
namespace Gs2.Unity.Gs2Enhance.Domain.Iterator
{
    ...
    public class EzDescribeRateModelsIterator : Gs2Iterator<Gs2.Unity.Gs2Enhance.Model.EzRateModel> {
        ...
        protected override IEnumerator Next(
            Action<AsyncResult<Gs2.Unity.Gs2Enhance.Model.EzRateModel>> callback
        )
        {
            yield return _iterator;
            callback.Invoke(new AsyncResult<Gs2.Unity.Gs2Enhance.Model.EzRateModel>(
                _iterator.Current == null ? null : Gs2.Unity.Gs2Enhance.Model.EzRateModel.FromModel(_iterator.Current),
                _iterator.Error
            ));
        }

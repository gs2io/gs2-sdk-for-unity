...
namespace Gs2.Unity.Gs2Enhance.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Enhance.Model.EzRateModel> RateModelsAsync(
        )
        {
            var it = _domain.RateModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Enhance.Model.EzRateModel.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Enhance.Model.EzUnleashRateModel> UnleashRateModelsAsync(
        )
        {
            var it = _domain.UnleashRateModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Enhance.Model.EzUnleashRateModel.FromModel(it.Current);
                }
            }
            finally
            {

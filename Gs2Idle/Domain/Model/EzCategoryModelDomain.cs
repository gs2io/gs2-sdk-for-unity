...
namespace Gs2.Unity.Gs2Idle.Domain.Model
{
    ...
    public partial class EzCategoryModelDomain {
        ...
        public IFuture<Gs2.Unity.Gs2Idle.Model.EzCategoryModel> Model()
        {
            return ModelFuture();
        }
        #endif
        ...
        public async UniTask<Gs2.Unity.Gs2Idle.Model.EzCategoryModel> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Idle.Model.EzCategoryModel> ModelAsync()
            #endif
        {
            ...
            return Gs2.Unity.Gs2Idle.Model.EzCategoryModel.FromModel(
                item
            );
        }
        #endif
        ...
        public IFuture<Gs2.Unity.Gs2Idle.Model.EzCategoryModel> ModelFuture()
        {
            IEnumerator Impl(Gs2Future<Gs2.Unity.Gs2Idle.Model.EzCategoryModel> self)
            {
                ...
                self.OnComplete(Gs2.Unity.Gs2Idle.Model.EzCategoryModel.FromModel(
                    item
                ));
            }
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Idle.Model.EzCategoryModel> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2Idle.Model.EzCategoryModel.FromModel(
                    item
                ));
            });
        }
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Idle.Model.EzCategoryModel> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Idle.Model.EzCategoryModel> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Idle.Model.EzCategoryModel> callback)
            #endif
        {

...
namespace Gs2.Unity.Gs2Idle.Domain.Model
{
    ...
    public partial class EzUserGameSessionDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Idle.Model.EzStatus> StatusesAsync(
        )
        {
            var it = _domain.StatusesAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Idle.Model.EzStatus.FromModel(it.Current);
                }
            }
            finally
            {

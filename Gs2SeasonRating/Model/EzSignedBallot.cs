...
namespace Gs2.Unity.Gs2SeasonRating.Model
{
	...
	public class EzSignedBallot
	{
        ...
        public Gs2.Gs2SeasonRating.Model.SignedBallot ToModel()
        {
            return new Gs2.Gs2SeasonRating.Model.SignedBallot {
                Body = Body,
                Signature = Signature,
            };
        }

        public static EzSignedBallot FromModel(Gs2.Gs2SeasonRating.Model.SignedBallot model)
        {

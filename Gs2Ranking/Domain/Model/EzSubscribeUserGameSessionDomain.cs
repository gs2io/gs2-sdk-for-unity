...
namespace Gs2.Unity.Gs2Ranking.Domain.Model
{
    ...
    public partial class EzSubscribeUserGameSessionDomain {
        private readonly Gs2.Gs2Ranking.Domain.Model.SubscribeUserAccessTokenDomain _domain;
        ...
        public EzSubscribeUserGameSessionDomain(
            Gs2.Gs2Ranking.Domain.Model.SubscribeUserAccessTokenDomain domain,
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Ranking.Model.EzSubscribeUser> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2Ranking.Model.EzSubscribeUser.FromModel(
                    item
                ));
            });
        }

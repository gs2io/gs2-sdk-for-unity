...
namespace Gs2.Unity.Gs2Ranking.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Ranking.Model.EzCategoryModel> CategoryModelsAsync(
        )
        {
            var it = _domain.CategoryModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Ranking.Model.EzCategoryModel.FromModel(it.Current);
                }
            }
            finally
            {

...
namespace Gs2.Unity.Gs2Ranking.Domain.Model
{
    ...
    public partial class EzRankingDomain {
        ...
        public long? Index => _domain?.Index;
        ...
        public async UniTask<Gs2.Unity.Gs2Ranking.Model.EzRanking> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Ranking.Model.EzRanking> ModelAsync()
            #endif
        {
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Ranking.Model.EzRanking> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Ranking.Model.EzRanking> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Ranking.Model.EzRanking> callback)
            #endif
        {

...
namespace Gs2.Unity.Gs2Ranking.Domain.Model
{
    ...
    public partial class EzScoreGameSessionDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2Ranking.Model.EzScore> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Ranking.Model.EzScore> ModelAsync()
            #endif
        {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Unity.Gs2Ranking.Model.EzScore> ModelFuture()
        {
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Ranking.Model.EzScore> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2Ranking.Model.EzScore.FromModel(
                    item
                ));
            });
        }
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Ranking.Model.EzScore> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Ranking.Model.EzScore> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Ranking.Model.EzScore> callback)
            #endif
        {

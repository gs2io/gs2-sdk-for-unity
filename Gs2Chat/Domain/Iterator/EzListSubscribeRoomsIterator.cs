...
namespace Gs2.Unity.Gs2Chat.Domain.Iterator
{
    ...
    public class EzListSubscribeRoomsIterator : Gs2Iterator<Gs2.Unity.Gs2Chat.Model.EzSubscribe>
    {
        ...
        private readonly string? _roomNamePrefix;
        ...
        )
        {
            ...
            _roomNamePrefix = roomNamePrefix;

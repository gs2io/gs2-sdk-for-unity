...
namespace Gs2.Unity.Gs2Chat.Domain.Iterator
{
    ...
    public class EzDescribeSubscribesIterator : Gs2Iterator<Gs2.Unity.Gs2Chat.Model.EzSubscribe> {
        ...
        public EzDescribeSubscribesIterator(
            Gs2.Gs2Chat.Domain.Iterator.DescribeSubscribesIterator iterator
        ) {
        ...
        protected override IEnumerator Next(
            Action<AsyncResult<Gs2.Unity.Gs2Chat.Model.EzSubscribe>> callback
        )
        {
            yield return _iterator;
            callback.Invoke(new AsyncResult<Gs2.Unity.Gs2Chat.Model.EzSubscribe>(
                _iterator.Current == null ? null : Gs2.Unity.Gs2Chat.Model.EzSubscribe.FromModel(_iterator.Current),
                _iterator.Error
            ));
        }

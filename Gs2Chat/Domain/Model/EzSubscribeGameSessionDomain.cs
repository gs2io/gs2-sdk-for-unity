    ...
    public partial class EzSubscribeGameSessionDomain {
        ...
        )
        {
            IEnumerator Impl(Gs2Future<Gs2.Unity.Gs2Chat.Domain.Model.EzSubscribeGameSessionDomain> self)
            {
                ...
                self.OnComplete(new Gs2.Unity.Gs2Chat.Domain.Model.EzSubscribeGameSessionDomain(future.Result, _profile));
            }
        ...
        )
        {
            IEnumerator Impl(Gs2Future<Gs2.Unity.Gs2Chat.Domain.Model.EzSubscribeGameSessionDomain> self)
            {
                var future = this._domain.UpdateNotificationTypeFuture(
        ...
        )
        {
            IEnumerator Impl(Gs2Future<Gs2.Unity.Gs2Chat.Domain.Model.EzSubscribeGameSessionDomain> self)
            {
                var future = this._domain.UnsubscribeFuture(

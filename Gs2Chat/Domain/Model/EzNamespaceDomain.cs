...
namespace Gs2.Unity.Gs2Chat.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Chat.Model.EzCategoryModel> CategoryModelsAsync(
        )
        {
            var it = _domain.CategoryModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Chat.Model.EzCategoryModel.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        public Gs2.Unity.Gs2Chat.Domain.Model.EzUserDomain User(
            ...
            return new Gs2.Unity.Gs2Chat.Domain.Model.EzUserDomain(
                _domain.User(
                    userId
                ),
                this._connection

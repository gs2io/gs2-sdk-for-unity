...
{
    public sealed class StaminaModel : AbstractTreeViewItem
    {
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2Stamina.ScriptableObject.StaminaModel.New(
                parent,
                this._item.Name
            );
            instance.name = this._item.Name + "StaminaModel";
            return instance;
        }

        public override void OnGUI() {
            StaminaModelEditorExt.OnGUI(this._item);

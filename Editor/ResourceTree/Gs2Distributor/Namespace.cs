...
namespace Gs2.Editor.ResourceTree.Gs2Distributor
{
    ...
    {
        private Gs2.Gs2Distributor.Model.Namespace _item;
        public string NamespaceName => _item.Name;

        public Namespace(
                int id,
                Gs2.Gs2Distributor.Model.Namespace item
        ) {
            this.id = id = id * 100;
            this.depth = 2;
            ...
            this.children = new TreeViewItem[] {
                new DistributorModelHolder(++id, this)
            }.ToList();
            this._item = item;
        }

        public override ScriptableObject ToScriptableObject() {
            var instance = Gs2.Unity.Gs2Distributor.ScriptableObject.Namespace.New(
                this._item.Name
            );

...
{
    public sealed class IncrementalRateModel : AbstractTreeViewItem
    {
        private Gs2.Gs2Exchange.Model.IncrementalRateModel _item;
        ...
        public IncrementalRateModel(
                int id,
                Namespace parent,
                Gs2.Gs2Exchange.Model.IncrementalRateModel item
        ) {
            this.id = id = id * 100;
            this.depth = 4;
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2Exchange.ScriptableObject.IncrementalRateModel.New(
                parent,
                this._item.Name
            );
            instance.name = this._item.Name + "IncrementalRateModel";
            return instance;
        }

        public override void OnGUI() {
            IncrementalRateModelEditorExt.OnGUI(this._item);
            
            if (GUILayout.Button("Create Reference Object")) {
                var directory = "Assets/Gs2/Resources";
                directory += "/Namespace" + "/" + NamespaceName;
                directory += "/IncrementalRateModel" + "/" + RateName;

...
{
    public sealed class OwnMold : AbstractTreeViewItem
    {
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2Formation.ScriptableObject.OwnMold.New(
                parent,
                this._item.Name
            );
            instance.name = this._item.Name + "OwnMold";
            return instance;
        }

...
{
    public static class SlotWithSignatureEditorExt
    {
        public static void OnGUI(Gs2.Gs2Formation.Model.SlotWithSignature item) {
            EditorGUI.BeginDisabledGroup(true);
            EditorGUILayout.TextField("Name", item.Name);
            EditorGUILayout.TextField("PropertyType", item.PropertyType);

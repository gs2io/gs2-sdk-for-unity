...
{
    public sealed class MoldModel : AbstractTreeViewItem
    {
        ...
        public MoldModel(
                int id,
                Namespace parent,
                Gs2.Gs2Formation.Model.MoldModel item
        ) {
            this.id = id = id * 100;
            this.depth = 4;
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2Formation.ScriptableObject.MoldModel.New(
                parent,
                this._item.Name
            );
            instance.name = this._item.Name + "MoldModel";
            return instance;
        }

        public override void OnGUI() {
            MoldModelEditorExt.OnGUI(this._item);

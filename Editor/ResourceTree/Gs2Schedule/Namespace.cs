...
using Gs2.Editor.ResourceTree.Gs2Schedule.Editor;
using UnityEditor;
...
namespace Gs2.Editor.ResourceTree.Gs2Schedule
{
    ...
    {
        private Gs2.Gs2Schedule.Model.Namespace _item;
        public string NamespaceName => _item.Name;

        public Namespace(
                int id,
                Gs2.Gs2Schedule.Model.Namespace item
        ) {
            this.id = id = id * 100;
            this.depth = 2;
        ...
        public override ScriptableObject ToScriptableObject() {
            var instance = Gs2.Unity.Gs2Schedule.ScriptableObject.Namespace.New(
                this._item.Name
            );
        ...
        public override void OnGUI() {
            ...
            if (GUILayout.Button("Create Reference Object")) {
                var directory = "Assets/Gs2/Resources/Schedule";

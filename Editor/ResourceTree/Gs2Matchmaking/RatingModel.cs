...
{
    public sealed class RatingModel : AbstractTreeViewItem
    {
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2Matchmaking.ScriptableObject.RatingModel.New(
                parent,
                this._item.Name
            );
            instance.name = this._item.Name + "RatingModel";
            return instance;
        }

        public override void OnGUI() {
            RatingModelEditorExt.OnGUI(this._item);

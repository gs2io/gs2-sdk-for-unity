...
namespace Gs2.Editor.ResourceTree.Gs2Matchmaking
{
    ...
    {
        private Gs2.Gs2Matchmaking.Model.Vote _item;
        private Namespace _parent;
        public string NamespaceName => _parent.NamespaceName;
        public string RatingName => _item.RatingName;
        public string GatheringName => _item.GatheringName;

        public Vote(
                int id,
                Namespace parent,
                Gs2.Gs2Matchmaking.Model.Vote item
        ) {
            this.id = id = id * 100;
            this.depth = 4;
            this.icon = EditorGUIUtility.ObjectContent(null, typeof(GameObject)).image.ToTexture2D();
            this.displayName = item.RatingName + item.GatheringName;
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2Matchmaking.ScriptableObject.Vote.New(
                parent,
                this._item.RatingName,
                this._item.GatheringName
            );
            instance.name = this._item.RatingName +this._item.GatheringName + "Vote";
            return instance;
        }

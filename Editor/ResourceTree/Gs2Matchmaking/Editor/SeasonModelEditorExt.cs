...
{
    public static class SeasonModelEditorExt
    {
        public static void OnGUI(Gs2.Gs2Matchmaking.Model.SeasonModel item) {
            EditorGUI.BeginDisabledGroup(true);
            EditorGUILayout.TextField("SeasonModelId", item.SeasonModelId);
            EditorGUILayout.TextField("Name", item.Name);
            EditorGUILayout.TextField("Metadata", item.Metadata);
            EditorGUILayout.TextField("MaximumParticipants", item.MaximumParticipants?.ToString());

...
{
    public static class VoteEditorExt
    {
        public static void OnGUI(Gs2.Gs2Matchmaking.Model.Vote item) {
            EditorGUI.BeginDisabledGroup(true);
            EditorGUILayout.TextField("VoteId", item.VoteId);
            EditorGUILayout.TextField("RatingName", item.RatingName);
            EditorGUILayout.TextField("GatheringName", item.GatheringName);

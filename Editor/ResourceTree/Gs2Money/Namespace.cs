...
namespace Gs2.Editor.ResourceTree.Gs2Money
{
    ...
    {
        private Gs2.Gs2Money.Model.Namespace _item;
        public string NamespaceName => _item.Name;

        public Namespace(
                int id,
                Gs2.Gs2Money.Model.Namespace item
        ) {
            this.id = id = id * 100;
            this.depth = 2;
            ...
            this.children = new TreeViewItem[] {
                new OwnWallet(++id, this)
            }.ToList();
            this._item = item;
        }

        public override ScriptableObject ToScriptableObject() {
            var instance = Gs2.Unity.Gs2Money.ScriptableObject.Namespace.New(
                this._item.Name
            );
        ...
        public override void OnGUI() {
            ...
            if (GUILayout.Button("Create Reference Object")) {
                var directory = "Assets/Gs2/Resources/Money";

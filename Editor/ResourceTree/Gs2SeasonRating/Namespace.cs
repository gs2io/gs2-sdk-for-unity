...
namespace Gs2.Editor.ResourceTree.Gs2SeasonRating
{
    ...
    {
        private Gs2.Gs2SeasonRating.Model.Namespace _item;
        public string NamespaceName => _item.Name;

        public Namespace(
                int id,
                Gs2.Gs2SeasonRating.Model.Namespace item
        ) {
            this.id = id = id * 100;
            this.depth = 2;
            ...
            this.children = new TreeViewItem[] {
                new MatchSessionHolder(++id, this),
        ...
        public override ScriptableObject ToScriptableObject() {
            var instance = Gs2.Unity.Gs2SeasonRating.ScriptableObject.Namespace.New(
                this._item.Name
            );

...
{
    public sealed class Vote : AbstractTreeViewItem
    {
        private Gs2.Gs2SeasonRating.Model.Vote _item;
        private Namespace _parent;
        public string NamespaceName => _parent.NamespaceName;
        public string SeasonName => _item.SeasonName;
        public string SessionName => _item.SessionName;

        public Vote(
                int id,
                Namespace parent,
                Gs2.Gs2SeasonRating.Model.Vote item
        ) {
            this.id = id = id * 100;
            this.depth = 4;
            this.icon = EditorGUIUtility.ObjectContent(null, typeof(GameObject)).image.ToTexture2D();
            this.displayName = item.SeasonName + item.SessionName;
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2SeasonRating.ScriptableObject.Vote.New(
                parent,
                this._item.SeasonName,
                this._item.SessionName
            );
            instance.name = this._item.SeasonName +this._item.SessionName + "Vote";
            return instance;
        }
        ...
        public override void OnGUI() {
            ...
            if (GUILayout.Button("Create Reference Object")) {
                ...
                directory += "/Vote" + "/" + SeasonName;
                directory += "/Vote" + "/" + SessionName;

...
{
    public sealed class MatchSession : AbstractTreeViewItem
    {
        private Gs2.Gs2SeasonRating.Model.MatchSession _item;
        private Namespace _parent;
        public string NamespaceName => _parent.NamespaceName;
        public string SessionName => _item.Name;

        public MatchSession(
                int id,
                Namespace parent,
                Gs2.Gs2SeasonRating.Model.MatchSession item
        ) {
            this.id = id = id * 100;
            this.depth = 4;
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2SeasonRating.ScriptableObject.MatchSession.New(
                parent,
                this._item.Name
            );
            instance.name = this._item.Name + "MatchSession";
            return instance;
        }

        public override void OnGUI() {
            MatchSessionEditorExt.OnGUI(this._item);
            
            if (GUILayout.Button("Create Reference Object")) {
                var directory = "Assets/Gs2/Resources/SeasonRating";
                directory += "/Namespace" + "/" + NamespaceName;
                directory += "/MatchSession" + "/" + SessionName;

...
{
    public static class MatchSessionEditorExt
    {
        public static void OnGUI(Gs2.Gs2SeasonRating.Model.MatchSession item) {
            EditorGUI.BeginDisabledGroup(true);
            EditorGUILayout.TextField("SessionId", item.SessionId);

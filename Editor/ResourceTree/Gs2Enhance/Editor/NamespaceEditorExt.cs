...
namespace Gs2.Editor.ResourceTree.Gs2Enhance.Editor
{
    ...
    {
        public static void OnGUI(Gs2.Gs2Enhance.Model.Namespace item) {
            ...
            if (item.EnhanceScript == null) {
                EditorGUILayout.TextField("EnhanceScript", "");
            }
            else {
                EditorGUILayout.LabelField("EnhanceScript");
                EditorGUI.indentLevel++;
                ScriptSettingEditorExt.OnGUI(item.EnhanceScript);
                EditorGUI.indentLevel--;
            }

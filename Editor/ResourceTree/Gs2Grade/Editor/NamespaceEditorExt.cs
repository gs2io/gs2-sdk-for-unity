...
namespace Gs2.Editor.ResourceTree.Gs2Grade.Editor
{
    ...
    {
        public static void OnGUI(Gs2.Gs2Grade.Model.Namespace item) {
            ...
            if (item.ChangeGradeScript == null) {
                EditorGUILayout.TextField("ChangeGradeScript", "");
            }
            else {
                EditorGUILayout.LabelField("ChangeGradeScript");
                EditorGUI.indentLevel++;
                ScriptSettingEditorExt.OnGUI(item.ChangeGradeScript);
                EditorGUI.indentLevel--;
            }

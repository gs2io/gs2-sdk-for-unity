...
namespace Gs2.Editor.ResourceTree.Gs2LoginReward.Editor
{
    ...
    {
        public static void OnGUI(Gs2.Gs2LoginReward.Model.Namespace item) {
            ...
            if (item.ReceiveScript == null) {
                EditorGUILayout.TextField("ReceiveScript", "");
            }
            else {
                EditorGUILayout.LabelField("ReceiveScript");
                EditorGUI.indentLevel++;

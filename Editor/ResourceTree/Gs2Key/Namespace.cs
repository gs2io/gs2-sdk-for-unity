...
namespace Gs2.Editor.ResourceTree.Gs2Key
{
    ...
    {
        private Gs2.Gs2Key.Model.Namespace _item;
        public string NamespaceName => _item.Name;

        public Namespace(
                int id,
                Gs2.Gs2Key.Model.Namespace item
        ) {
            this.id = id = id * 100;
            this.depth = 2;
            ...
            this.children = new TreeViewItem[] {
                new KeyHolder(++id, this),
                new GitHubApiKeyHolder(++id, this)
            }.ToList();
            this._item = item;
        }

        public override ScriptableObject ToScriptableObject() {
            var instance = Gs2.Unity.Gs2Key.ScriptableObject.Namespace.New(
                this._item.Name
            );

...
namespace Gs2.Editor.ResourceTree.Gs2Realtime.Editor
{
    ...
    {
        public static void OnGUI(Gs2.Gs2Realtime.Model.Namespace item) {
            ...
            if (item.CreateNotification == null) {
                EditorGUILayout.TextField("CreateNotification", "");
            }
            else {
                EditorGUILayout.LabelField("CreateNotification");
                EditorGUI.indentLevel++;
                NotificationSettingEditorExt.OnGUI(item.CreateNotification);
                EditorGUI.indentLevel--;
            }

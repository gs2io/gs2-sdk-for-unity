...
namespace Gs2.Editor.ResourceTree.Gs2Realtime
{
    ...
    {
        private Gs2.Gs2Realtime.Model.Namespace _item;
        public string NamespaceName => _item.Name;

        public Namespace(
                int id,
                Gs2.Gs2Realtime.Model.Namespace item
        ) {
            this.id = id = id * 100;
            this.depth = 2;
            ...
            this.children = new TreeViewItem[] {
                new RoomHolder(++id, this)
            }.ToList();
            this._item = item;
        }

        public override ScriptableObject ToScriptableObject() {
            var instance = Gs2.Unity.Gs2Realtime.ScriptableObject.Namespace.New(
                this._item.Name
            );
        ...
        public override void OnGUI() {
            ...
            if (GUILayout.Button("Create Reference Object")) {
                var directory = "Assets/Gs2/Resources/Realtime";

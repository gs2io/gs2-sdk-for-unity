...
{
    public sealed class RarityParameterModel : AbstractTreeViewItem
    {
        private Gs2.Gs2Enchant.Model.RarityParameterModel _item;
        ...
        public RarityParameterModel(
                int id,
                Namespace parent,
                Gs2.Gs2Enchant.Model.RarityParameterModel item
        ) {
            this.id = id = id * 100;
            this.depth = 4;
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2Enchant.ScriptableObject.RarityParameterModel.New(
                parent,
                this._item.Name
            );
            instance.name = this._item.Name + "RarityParameterModel";
            return instance;
        }

        public override void OnGUI() {
            RarityParameterModelEditorExt.OnGUI(this._item);
            
            if (GUILayout.Button("Create Reference Object")) {
                var directory = "Assets/Gs2/Resources";
                directory += "/Namespace" + "/" + NamespaceName;
                directory += "/RarityParameterModel" + "/" + ParameterName;

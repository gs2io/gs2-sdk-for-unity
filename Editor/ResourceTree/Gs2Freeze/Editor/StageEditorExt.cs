...
namespace Gs2.Editor.ResourceTree.Gs2Freeze.Editor
{
    public static class StageEditorExt
    {
        public static void OnGUI(Gs2.Gs2Freeze.Model.Stage item) {
            EditorGUI.BeginDisabledGroup(true);
            EditorGUILayout.TextField("StageId", item.StageId);
            EditorGUILayout.TextField("Name", item.Name);
            EditorGUILayout.TextField("SourceStageName", item.SourceStageName);
            EditorGUILayout.TextField("SortNumber", item.SortNumber?.ToString());

...
{
    public sealed class OwnCounter : AbstractTreeViewItem
    {
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2Mission.ScriptableObject.OwnCounter.New(
                parent,
                this._item.Name
            );
            instance.name = this._item.Name + "OwnCounter";
            return instance;
        }

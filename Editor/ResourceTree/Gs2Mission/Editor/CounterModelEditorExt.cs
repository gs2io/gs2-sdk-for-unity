...
{
    public static class CounterModelEditorExt
    {
        public static void OnGUI(Gs2.Gs2Mission.Model.CounterModel item) {
            EditorGUI.BeginDisabledGroup(true);
            EditorGUILayout.TextField("CounterId", item.CounterId);

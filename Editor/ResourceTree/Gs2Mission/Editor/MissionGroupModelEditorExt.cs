...
{
    public static class MissionGroupModelEditorExt
    {
        public static void OnGUI(Gs2.Gs2Mission.Model.MissionGroupModel item) {
            EditorGUI.BeginDisabledGroup(true);
            EditorGUILayout.TextField("MissionGroupId", item.MissionGroupId);

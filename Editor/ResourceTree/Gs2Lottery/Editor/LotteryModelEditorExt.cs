...
{
    public static class LotteryModelEditorExt
    {
        public static void OnGUI(Gs2.Gs2Lottery.Model.LotteryModel item) {
            EditorGUI.BeginDisabledGroup(true);
            EditorGUILayout.TextField("LotteryModelId", item.LotteryModelId);

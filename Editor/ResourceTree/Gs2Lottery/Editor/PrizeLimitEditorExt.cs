...
{
    public static class PrizeLimitEditorExt
    {
        public static void OnGUI(Gs2.Gs2Lottery.Model.PrizeLimit item) {
            EditorGUI.BeginDisabledGroup(true);
            EditorGUILayout.TextField("PrizeLimitId", item.PrizeLimitId);
            EditorGUILayout.TextField("PrizeId", item.PrizeId);
            EditorGUILayout.TextField("DrawnCount", item.DrawnCount?.ToString());

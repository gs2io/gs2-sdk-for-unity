...
{
    public sealed class LotteryModel : AbstractTreeViewItem
    {
        private Gs2.Gs2Lottery.Model.LotteryModel _item;
        private Namespace _parent;
        public string NamespaceName => _parent.NamespaceName;
        public string LotteryName => _item.Name;
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2Lottery.ScriptableObject.LotteryModel.New(
                parent,
                this._item.Name
            );
            instance.name = this._item.Name + "LotteryModel";
            return instance;
        }

        public override void OnGUI() {
            LotteryModelEditorExt.OnGUI(this._item);
            
            if (GUILayout.Button("Create Reference Object")) {
                var directory = "Assets/Gs2/Resources";
                directory += "/Namespace" + "/" + NamespaceName;
                directory += "/LotteryModel" + "/" + LotteryName;

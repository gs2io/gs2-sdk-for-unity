...
{
    public static class InventoryModelEditorExt
    {
        public static void OnGUI(Gs2.Gs2Inventory.Model.InventoryModel item) {
            EditorGUI.BeginDisabledGroup(true);
            EditorGUILayout.TextField("InventoryModelId", item.InventoryModelId);
            ...
            EditorGUILayout.TextField("ProtectReferencedItem", item.ProtectReferencedItem?.ToString());

...
{
    public sealed class OwnBigInventory : AbstractTreeViewItem
    {
        ...
        public OwnBigInventory(
            ...
            this.displayName = "OwnBigInventory";
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2Inventory.ScriptableObject.OwnBigInventory.New(
                parent,
                this._item.Name
            );
            instance.name = this._item.Name + "OwnBigInventory";
            return instance;
        }

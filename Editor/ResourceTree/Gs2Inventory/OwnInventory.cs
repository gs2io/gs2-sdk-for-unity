...
{
    public sealed class OwnInventory : AbstractTreeViewItem
    {
        private Namespace _parent;
        private Gs2.Gs2Inventory.Model.InventoryModel _item;
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2Inventory.ScriptableObject.OwnInventory.New(
                parent,
                this._item.Name
            );
            instance.name = this._item.Name + "OwnInventory";
            return instance;
        }

...
{
    public sealed class InventoryModel : AbstractTreeViewItem
    {
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2Inventory.ScriptableObject.InventoryModel.New(
                parent,
                this._item.Name
            );
            instance.name = this._item.Name + "InventoryModel";
            return instance;
        }

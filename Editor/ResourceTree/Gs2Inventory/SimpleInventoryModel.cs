...
{
    public sealed class SimpleInventoryModel : AbstractTreeViewItem
    {
        ...
        public SimpleInventoryModel(
            ...
            this.children = new TreeViewItem[] {
                new SimpleItemModelHolder(++id, this),
                new OwnSimpleInventory(++id, parent, item)
            }.ToList();
            this._parent = parent;
            this._item = item;
        }
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2Inventory.ScriptableObject.SimpleInventoryModel.New(
                parent,
                this._item.Name
            );
            instance.name = this._item.Name + "SimpleInventoryModel";
            return instance;
        }

        public override void OnGUI() {
            SimpleInventoryModelEditorExt.OnGUI(this._item);

...
namespace Gs2.Editor.ResourceTree.Gs2Datastore.Editor
{
    ...
    {
        public static void OnGUI(Gs2.Gs2Datastore.Model.Namespace item) {
            ...
            if (item.DoneUploadScript == null) {
                EditorGUILayout.TextField("DoneUploadScript", "");
            }
            else {
                EditorGUILayout.LabelField("DoneUploadScript");
                EditorGUI.indentLevel++;
                ScriptSettingEditorExt.OnGUI(item.DoneUploadScript);
                EditorGUI.indentLevel--;
            }

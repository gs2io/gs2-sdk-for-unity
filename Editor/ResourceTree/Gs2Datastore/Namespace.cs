...
using Gs2.Editor.ResourceTree.Gs2Datastore.Editor;
using UnityEditor;
using UnityEditor.IMGUI.Controls;
using UnityEngine;

namespace Gs2.Editor.ResourceTree.Gs2Datastore
{
    public sealed class Namespace : AbstractTreeViewItem
    {
        private Gs2.Gs2Datastore.Model.Namespace _item;
        public string NamespaceName => _item.Name;

        public Namespace(
                int id,
                Gs2.Gs2Datastore.Model.Namespace item
        ) {
            this.id = id = id * 100;
            this.depth = 2;
        ...
        public override ScriptableObject ToScriptableObject() {
            var instance = Gs2.Unity.Gs2Datastore.ScriptableObject.Namespace.New(
                this._item.Name
            );

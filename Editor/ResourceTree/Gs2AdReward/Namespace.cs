...
using Gs2.Editor.ResourceTree.Gs2AdReward.Editor;
using UnityEditor;
using UnityEditor.IMGUI.Controls;
using UnityEngine;

namespace Gs2.Editor.ResourceTree.Gs2AdReward
{
    public sealed class Namespace : AbstractTreeViewItem
    {
        private Gs2.Gs2AdReward.Model.Namespace _item;
        public string NamespaceName => _item.Name;

        public Namespace(
                int id,
                Gs2.Gs2AdReward.Model.Namespace item
        ) {
            this.id = id = id * 100;
            this.depth = 2;
        ...
        public override ScriptableObject ToScriptableObject() {
            var instance = Gs2.Unity.Gs2AdReward.ScriptableObject.Namespace.New(
                this._item.Name
            );
        ...
        public override void OnGUI() {
            ...
            if (GUILayout.Button("Create Reference Object")) {
                var directory = "Assets/Gs2/Resources/AdReward";

...
{
    public sealed class OwnAccount : AbstractTreeViewItem
    {
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2Account.ScriptableObject.OwnAccount.New(
                parent
            );
            instance.name = "OwnAccount";
            return instance;
        }

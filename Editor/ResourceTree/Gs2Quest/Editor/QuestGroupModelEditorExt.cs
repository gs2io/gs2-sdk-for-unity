...
{
    public static class QuestGroupModelEditorExt
    {
        public static void OnGUI(Gs2.Gs2Quest.Model.QuestGroupModel item) {
            EditorGUI.BeginDisabledGroup(true);
            EditorGUILayout.TextField("QuestGroupModelId", item.QuestGroupModelId);

...
namespace Gs2.Editor.ResourceTree.Gs2Quest
{
    ...
    {
        private Gs2.Gs2Quest.Model.Namespace _item;
        public string NamespaceName => _item.Name;

        public Namespace(
                int id,
                Gs2.Gs2Quest.Model.Namespace item
        ) {
            this.id = id = id * 100;
            this.depth = 2;
            ...
            this.children = new TreeViewItem[] {
                new QuestGroupModelHolder(++id, this)
            }.ToList();
            this._item = item;
        }

        public override ScriptableObject ToScriptableObject() {
            var instance = Gs2.Unity.Gs2Quest.ScriptableObject.Namespace.New(
                this._item.Name
            );

...
namespace Gs2.Editor.ResourceTree.Gs2Log.Editor
{
    ...
    {
        public static void OnGUI(Gs2.Gs2Log.Model.Namespace item) {
            ...
            EditorGUILayout.TextField("GcpCredentialJson", item.GcpCredentialJson);
            EditorGUILayout.TextField("BigQueryDatasetName", item.BigQueryDatasetName);
            EditorGUILayout.TextField("LogExpireDays", item.LogExpireDays?.ToString());
            EditorGUILayout.TextField("AwsRegion", item.AwsRegion);

...
{
    public static class InsightEditorExt
    {
        public static void OnGUI(Gs2.Gs2Log.Model.Insight item) {
            EditorGUI.BeginDisabledGroup(true);
            EditorGUILayout.TextField("InsightId", item.InsightId);
            EditorGUILayout.TextField("Name", item.Name);
            EditorGUILayout.TextField("TaskId", item.TaskId);
            EditorGUILayout.TextField("Host", item.Host);
            EditorGUILayout.TextField("Password", item.Password);

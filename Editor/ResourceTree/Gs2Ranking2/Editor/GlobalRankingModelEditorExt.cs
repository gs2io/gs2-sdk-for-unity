...
{
    public static class GlobalRankingModelEditorExt
    {
        public static void OnGUI(Gs2.Gs2Ranking2.Model.GlobalRankingModel item) {
            EditorGUI.BeginDisabledGroup(true);
            EditorGUILayout.TextField("GlobalRankingModelId", item.GlobalRankingModelId);

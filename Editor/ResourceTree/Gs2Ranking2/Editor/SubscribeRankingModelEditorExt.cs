...
{
    public static class SubscribeRankingModelEditorExt
    {
        public static void OnGUI(Gs2.Gs2Ranking2.Model.SubscribeRankingModel item) {
            EditorGUI.BeginDisabledGroup(true);
            EditorGUILayout.TextField("SubscribeRankingModelId", item.SubscribeRankingModelId);

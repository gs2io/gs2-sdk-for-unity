...
namespace Gs2.Editor.ResourceTree.Gs2Ranking2
{
    ...
    {
        private Gs2.Gs2Ranking2.Model.Namespace _item;
        public string NamespaceName => _item.Name;

        public Namespace(
                int id,
                Gs2.Gs2Ranking2.Model.Namespace item
        ) {
            this.id = id = id * 100;
            this.depth = 2;
            ...
            this.children = new TreeViewItem[] {
                new GlobalRankingModelHolder(++id, this),
                new ClusterRankingModelHolder(++id, this),
                new SubscribeRankingModelHolder(++id, this)
            }.ToList();
            this._item = item;
        }

        public override ScriptableObject ToScriptableObject() {
            var instance = Gs2.Unity.Gs2Ranking2.ScriptableObject.Namespace.New(
                this._item.Name
            );

...
namespace Gs2.Editor.ResourceTree.Gs2Dictionary
{
    ...
    {
        private Gs2.Gs2Dictionary.Model.Namespace _item;
        public string NamespaceName => _item.Name;

        public Namespace(
                int id,
                Gs2.Gs2Dictionary.Model.Namespace item
        ) {
            this.id = id = id * 100;
            this.depth = 2;
            ...
            this.children = new TreeViewItem[] {
                new EntryModelHolder(++id, this)
            }.ToList();
            this._item = item;
        }

        public override ScriptableObject ToScriptableObject() {
            var instance = Gs2.Unity.Gs2Dictionary.ScriptableObject.Namespace.New(
                this._item.Name
            );

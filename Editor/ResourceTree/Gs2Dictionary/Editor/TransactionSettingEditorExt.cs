...
namespace Gs2.Editor.ResourceTree.Gs2Dictionary.Editor
{
    ...
    {
        public static void OnGUI(Gs2.Gs2Dictionary.Model.TransactionSetting item) {
            ...
            EditorGUILayout.TextField("EnableSequentialExecution", item.EnableSequentialExecution?.ToString());

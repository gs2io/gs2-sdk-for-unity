...
namespace Gs2.Editor.ResourceTree.Gs2Dictionary.Editor
{
    ...
    {
        public static void OnGUI(Gs2.Gs2Dictionary.Model.Namespace item) {
            ...
            if (item.EntryScript == null) {
                EditorGUILayout.TextField("EntryScript", "");
            }
            else {
                EditorGUILayout.LabelField("EntryScript");
                EditorGUI.indentLevel++;

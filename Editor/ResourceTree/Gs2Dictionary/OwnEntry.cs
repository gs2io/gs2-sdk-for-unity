...
{
    public sealed class OwnEntry : AbstractTreeViewItem
    {
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2Dictionary.ScriptableObject.OwnEntry.New(
                parent,
                this._item.Name
            );
            instance.name = this._item.Name + "OwnEntry";
            return instance;
        }

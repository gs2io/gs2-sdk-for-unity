...
{
    public sealed class StoreContentModel : AbstractTreeViewItem
    {
        private Gs2.Gs2Money2.Model.StoreContentModel _item;
        ...
        public StoreContentModel(
                int id,
                Namespace parent,
                Gs2.Gs2Money2.Model.StoreContentModel item
        ) {
            this.id = id = id * 100;
            this.depth = 4;
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2Money2.ScriptableObject.StoreContentModel.New(
                parent,
                this._item.Name
            );
            instance.name = this._item.Name + "StoreContentModel";
            return instance;
        }

        public override void OnGUI() {
            StoreContentModelEditorExt.OnGUI(this._item);
            
            if (GUILayout.Button("Create Reference Object")) {
                var directory = "Assets/Gs2/Resources/Money2";
                directory += "/Namespace" + "/" + NamespaceName;
                directory += "/StoreContentModel" + "/" + ContentName;

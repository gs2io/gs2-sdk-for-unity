...
{
    public static class UnusedBalanceEditorExt
    {
        public static void OnGUI(Gs2.Gs2Money2.Model.UnusedBalance item) {
            EditorGUI.BeginDisabledGroup(true);
            EditorGUILayout.TextField("UnusedBalanceId", item.UnusedBalanceId);

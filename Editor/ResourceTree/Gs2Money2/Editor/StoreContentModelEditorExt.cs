...
{
    public static class StoreContentModelEditorExt
    {
        public static void OnGUI(Gs2.Gs2Money2.Model.StoreContentModel item) {
            EditorGUI.BeginDisabledGroup(true);
            EditorGUILayout.TextField("StoreContentModelId", item.StoreContentModelId);
            ...
            if (item.AppleAppStore == null) {
                ...
                AppleAppStoreContentEditorExt.OnGUI(item.AppleAppStore);
                EditorGUI.indentLevel--;
            }
            if (item.GooglePlay == null) {
                ...
                EditorGUI.indentLevel++;
                GooglePlayContentEditorExt.OnGUI(item.GooglePlay);
                EditorGUI.indentLevel--;
            }

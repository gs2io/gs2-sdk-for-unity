...
{
    public sealed class Inbox : AbstractTreeViewItem
    {
        private Gs2.Gs2Guild.Model.Inbox _item;
        ...
        public override ScriptableObject ToScriptableObject() {
            ...
            var instance = Gs2.Unity.Gs2Guild.ScriptableObject.Inbox.New(
                parent
            );
            instance.name =  "Inbox";
            return instance;
        ...
        public override void OnGUI() {
            InboxEditorExt.OnGUI(this._item);

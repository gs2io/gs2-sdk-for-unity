...
{
    public sealed class ReceiveMemberRequest : AbstractTreeViewItem
    {
        private Gs2.Gs2Guild.Model.ReceiveMemberRequest _item;
        ...
        public ReceiveMemberRequest(
                int id,
                Guild parent,
                Gs2.Gs2Guild.Model.ReceiveMemberRequest item
        ) {
            this.id = id = id * 100;
            this.depth = 6;
        ...
        public override void OnGUI() {
            ReceiveMemberRequestEditorExt.OnGUI(this._item);

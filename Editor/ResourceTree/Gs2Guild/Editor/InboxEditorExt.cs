...
{
    public static class InboxEditorExt
    {
        public static void OnGUI(Gs2.Gs2Guild.Model.Inbox item) {
            EditorGUI.BeginDisabledGroup(true);
            EditorGUILayout.TextField("InboxId", item.InboxId);
            EditorGUILayout.TextField("GuildName", item.GuildName);

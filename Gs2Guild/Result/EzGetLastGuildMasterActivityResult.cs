...
namespace Gs2.Unity.Gs2Guild.Result
{
	...
	public class EzGetLastGuildMasterActivityResult
	{
		[SerializeField]
        ...
        public static EzGetLastGuildMasterActivityResult FromModel(Gs2.Gs2Guild.Result.GetLastGuildMasterActivityResult model)
        {
            return new EzGetLastGuildMasterActivityResult {

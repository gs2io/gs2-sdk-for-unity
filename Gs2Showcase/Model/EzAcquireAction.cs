...
namespace Gs2.Unity.Gs2Showcase.Model
{
	...
	public class EzAcquireAction
	{
        ...
        public Gs2.Gs2Showcase.Model.AcquireAction ToModel()
        {
            return new Gs2.Gs2Showcase.Model.AcquireAction {
                Action = Action,
                Request = Request,
            };
        }

        public static EzAcquireAction FromModel(Gs2.Gs2Showcase.Model.AcquireAction model)
        {

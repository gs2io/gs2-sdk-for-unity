...
namespace Gs2.Unity.Gs2Showcase.Domain.Iterator
{
    ...
    public class EzDescribeRandomShowcaseSalesItemsIterator : Gs2Iterator<Gs2.Unity.Gs2Showcase.Model.EzRandomDisplayItem> {
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Unity.Gs2Showcase.Model.EzRandomDisplayItem> GetAsyncEnumerator(
        ...
        protected override IEnumerator Next(
            Action<AsyncResult<Gs2.Unity.Gs2Showcase.Model.EzRandomDisplayItem>> callback
        )
        {
            yield return _iterator;
            callback.Invoke(new AsyncResult<Gs2.Unity.Gs2Showcase.Model.EzRandomDisplayItem>(
                _iterator.Current == null ? null : Gs2.Unity.Gs2Showcase.Model.EzRandomDisplayItem.FromModel(_iterator.Current),
                _iterator.Error
            ));
        }

...
namespace Gs2.Unity.Gs2Showcase.Domain.Iterator
{
    ...
    public class EzListRandomShowcaseDisplayItemsIterator : Gs2Iterator<Gs2.Unity.Gs2Showcase.Model.EzRandomDisplayItem>
    {
        ...
        public EzListRandomShowcaseDisplayItemsIterator(
        ...
        )
        {
            ...
            _it = _domain.RandomDisplayItems(
            );
        }

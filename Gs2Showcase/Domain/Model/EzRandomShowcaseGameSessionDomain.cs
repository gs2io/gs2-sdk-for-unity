...
namespace Gs2.Unity.Gs2Showcase.Domain.Model
{
    ...
    public partial class EzRandomShowcaseGameSessionDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Showcase.Model.EzRandomDisplayItem> RandomDisplayItemsAsync(
        )
        {
            var it = _domain.RandomDisplayItemsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Showcase.Model.EzRandomDisplayItem.FromModel(it.Current);
                }
            }
            finally
            {

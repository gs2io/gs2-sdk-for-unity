...
namespace Gs2.Unity.Gs2Showcase.Domain.Model
{
    ...
    public partial class EzShowcaseGameSessionDomain {
        ...
        public Gs2.Unity.Gs2Showcase.Domain.Model.EzDisplayItemGameSessionDomain DisplayItem(
            ...
            return new Gs2.Unity.Gs2Showcase.Domain.Model.EzDisplayItemGameSessionDomain(
                _domain.DisplayItem(
                    displayItemId
                ),
                this._gameSession,
        ...
        public async UniTask<Gs2.Unity.Gs2Showcase.Model.EzShowcase> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2Showcase.Model.EzShowcase> ModelAsync()
            #endif
        {
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2Showcase.Model.EzShowcase> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2Showcase.Model.EzShowcase.FromModel(
                    item
                ));
            });
        }
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2Showcase.Model.EzShowcase> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Showcase.Model.EzShowcase> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2Showcase.Model.EzShowcase> callback)
            #endif
        {

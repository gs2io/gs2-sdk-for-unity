...
namespace Gs2.Unity.Gs2JobQueue.Domain.Model
{
    ...
    public partial class EzJobGameSessionDomain {
        ...
        public async UniTask<Gs2.Unity.Gs2JobQueue.Model.EzJob> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2JobQueue.Model.EzJob> ModelAsync()
            #endif
        {
        ...
        public ulong Subscribe(Action<Gs2.Unity.Gs2JobQueue.Model.EzJob> callback)
        {
            return this._domain.Subscribe(item => {
                callback.Invoke(item == null ? null : Gs2.Unity.Gs2JobQueue.Model.EzJob.FromModel(
                    item
                ));
            });
        }
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2JobQueue.Model.EzJob> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2JobQueue.Model.EzJob> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2JobQueue.Model.EzJob> callback)
            #endif
        {

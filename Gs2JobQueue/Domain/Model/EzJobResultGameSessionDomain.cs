...
namespace Gs2.Unity.Gs2JobQueue.Domain.Model
{
    ...
    public partial class EzJobResultGameSessionDomain {
        private readonly Gs2.Gs2JobQueue.Domain.Model.JobResultAccessTokenDomain _domain;
        ...
        public async UniTask<Gs2.Unity.Gs2JobQueue.Model.EzJobResult> ModelAsync()
            #else
        public async Task<Gs2.Unity.Gs2JobQueue.Model.EzJobResult> ModelAsync()
            #endif
        {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Unity.Gs2JobQueue.Model.EzJobResult> ModelFuture()
        {
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Unity.Gs2JobQueue.Model.EzJobResult> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2JobQueue.Model.EzJobResult> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Unity.Gs2JobQueue.Model.EzJobResult> callback)
            #endif
        {

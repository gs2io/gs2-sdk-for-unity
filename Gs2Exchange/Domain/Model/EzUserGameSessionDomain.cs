...
namespace Gs2.Unity.Gs2Exchange.Domain.Model
{
    ...
    public partial class EzUserGameSessionDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Exchange.Model.EzAwait> AwaitsAsync(
              string? rateName = null
        )
        {
            var it = _domain.AwaitsAsync(
            ...
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Exchange.Model.EzAwait.FromModel(it.Current);
                }
            }
            finally
            {

...
namespace Gs2.Unity.Gs2Exchange.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Exchange.Model.EzRateModel> RateModelsAsync(
        )
        {
            var it = _domain.RateModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Exchange.Model.EzRateModel.FromModel(it.Current);
                }
            }
            finally
            {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2Exchange.Model.EzIncrementalRateModel> IncrementalRateModelsAsync(
        )
        {
            var it = _domain.IncrementalRateModelsAsync(
            ).GetAsyncEnumerator();
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2Exchange.Model.EzIncrementalRateModel.FromModel(it.Current);
                }
            }
            finally
            {

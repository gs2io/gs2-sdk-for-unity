...
namespace Gs2.Unity.Gs2Exchange.Domain.Iterator
{
    ...
    public class EzDescribeAwaitsIterator : Gs2Iterator<Gs2.Unity.Gs2Exchange.Model.EzAwait> {
        ...
        public EzDescribeAwaitsIterator(
            Gs2.Gs2Exchange.Domain.Iterator.DescribeAwaitsIterator iterator
        ) {
        ...
        protected override IEnumerator Next(
            Action<AsyncResult<Gs2.Unity.Gs2Exchange.Model.EzAwait>> callback
        )
        {
            yield return _iterator;
            callback.Invoke(new AsyncResult<Gs2.Unity.Gs2Exchange.Model.EzAwait>(
                _iterator.Current == null ? null : Gs2.Unity.Gs2Exchange.Model.EzAwait.FromModel(_iterator.Current),
                _iterator.Error
            ));
        }

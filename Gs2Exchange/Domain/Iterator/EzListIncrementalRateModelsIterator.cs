...
namespace Gs2.Unity.Gs2Exchange.Domain.Iterator
{
    ...
    public class EzListIncrementalRateModelsIterator : Gs2Iterator<Gs2.Unity.Gs2Exchange.Model.EzIncrementalRateModel>
    {
        ...
        public EzListIncrementalRateModelsIterator(
        ...
        )
        {
            ...
            _it = _domain.IncrementalRateModels(
            );
        }

...
namespace Gs2.Unity.Gs2Exchange.Model
{
	...
	public class EzAcquireAction
	{
        ...
        public Gs2.Gs2Exchange.Model.AcquireAction ToModel()
        {
            return new Gs2.Gs2Exchange.Model.AcquireAction {
                Action = Action,
                Request = Request,
            };
        }

        public static EzAcquireAction FromModel(Gs2.Gs2Exchange.Model.AcquireAction model)
        {

...
namespace Gs2.Unity.Gs2Exchange.Model
{
	...
	public class EzConsumeAction
	{
        ...
        public Gs2.Gs2Exchange.Model.ConsumeAction ToModel()
        {
            return new Gs2.Gs2Exchange.Model.ConsumeAction {
                Action = Action,
                Request = Request,
            };
        }

        public static EzConsumeAction FromModel(Gs2.Gs2Exchange.Model.ConsumeAction model)
        {

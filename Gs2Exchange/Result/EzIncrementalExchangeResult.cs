...
namespace Gs2.Unity.Gs2Exchange.Result
{
	...
	public class EzIncrementalExchangeResult
	{
		[SerializeField]
        ...
        public static EzIncrementalExchangeResult FromModel(Gs2.Gs2Exchange.Result.IncrementalExchangeResult model)
        {
            return new EzIncrementalExchangeResult {

...
namespace Gs2.Unity.Gs2Exchange.Result
{
	...
	public class EzDeleteAwaitResult
	{
		[SerializeField]
		public Gs2.Unity.Gs2Exchange.Model.EzAwait Item;

        public static EzDeleteAwaitResult FromModel(Gs2.Gs2Exchange.Result.DeleteAwaitResult model)
        {
            return new EzDeleteAwaitResult {

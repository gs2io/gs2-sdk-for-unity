...
{
	[Preserve]
	public class AcquireItemSetByStampSheetRequest : Gs2Request<AcquireItemSetByStampSheetRequest>
	{
    	...
    	[Preserve]
        public static AcquireItemSetByStampSheetRequest FromDict(JsonData data)
        {

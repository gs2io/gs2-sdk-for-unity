...
{
	[Preserve]
	public class DescribeItemModelMastersResult
	{
        /** アイテムモデルマスターのリスト */
        public List<ItemModelMaster> items { set; get; }
    	...
    	[Preserve]
        public static DescribeItemModelMastersResult FromDict(JsonData data)
        {

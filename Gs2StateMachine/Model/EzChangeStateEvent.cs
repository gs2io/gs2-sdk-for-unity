...
namespace Gs2.Unity.Gs2StateMachine.Model
{
	...
	public class EzChangeStateEvent
	{
        ...
        {
            return new Gs2.Gs2StateMachine.Model.ChangeStateEvent {
                TaskName = TaskName,
                Hash = Hash,
                Timestamp = Timestamp,
            };
        ...
        public static EzChangeStateEvent FromModel(Gs2.Gs2StateMachine.Model.ChangeStateEvent model)
        {
            return new EzChangeStateEvent {
                TaskName = model.TaskName == null ? null : model.TaskName,
                Hash = model.Hash == null ? null : model.Hash,

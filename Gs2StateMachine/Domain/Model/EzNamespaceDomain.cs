...
namespace Gs2.Unity.Gs2StateMachine.Domain.Model
{
    ...
    public partial class EzNamespaceDomain {
        private readonly Gs2.Gs2StateMachine.Domain.Model.NamespaceDomain _domain;
        ...
        public EzNamespaceDomain(
            Gs2.Gs2StateMachine.Domain.Model.NamespaceDomain domain,
        ...
        public Gs2.Unity.Gs2StateMachine.Domain.Model.EzUserDomain User(
            string userId
        ) {
            return new Gs2.Unity.Gs2StateMachine.Domain.Model.EzUserDomain(
                _domain.User(
                    userId
                ),
                this._connection

...
namespace Gs2.Unity.Gs2StateMachine.Domain.Model
{
    ...
    public partial class EzUserGameSessionDomain {
        ...
        )
        {
            ...
            #else
        public async IAsyncEnumerable<Gs2.Unity.Gs2StateMachine.Model.EzStatus> StatusesAsync(
              string? status = null
        )
        {
            var it = _domain.StatusesAsync(
            ...
            try
            {
                ...
                {
                    yield return it.Current == null ? null : Gs2.Unity.Gs2StateMachine.Model.EzStatus.FromModel(it.Current);
                }
            }
            finally
            {
